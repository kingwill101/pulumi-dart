...
class AlertRuleFusionArgs {
  ...
  AlertRuleFusionArgs({
    required String alertRuleTemplateGuid,
    bool? enabled,
    required String logAnalyticsWorkspaceId,
    String? name,
    List<AlertRuleFusionSource>? sources,
  }) :
  ...
  factory AlertRuleFusionArgs.fromMap(Map<String, dynamic> map) {
    return AlertRuleFusionArgs(
      alertRuleTemplateGuid: map['alertRuleTemplateGuid'] as String,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      logAnalyticsWorkspaceId: map['logAnalyticsWorkspaceId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      sources: map['sources'] == null ? null : pulumi.Input.decodeList<AlertRuleFusionSource>(map['sources'], (value) => AlertRuleFusionSource.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
