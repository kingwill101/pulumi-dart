...
import 'data_connector_azure_active_directory_args.dart';
...
/// ```
class DataConnectorAzureActiveDirectory extends pulumi.CustomResource {
  ...
  /// Creates a new [DataConnectorAzureActiveDirectory].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DataConnectorAzureActiveDirectory]. {@macro pulumi_sentinel_data_connector_azure_active_directory_data_connector_azure_active_directory_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DataConnectorAzureActiveDirectory(
    String name, {
    DataConnectorAzureActiveDirectoryArgs? args,
