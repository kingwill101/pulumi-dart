...
class DataConnectorOffice365Args {
  ...
  factory DataConnectorOffice365Args.fromMap(Map<String, dynamic> map) {
    return DataConnectorOffice365Args(
      exchangeEnabled: map['exchangeEnabled'] == null ? null : map['exchangeEnabled'] as bool,
      logAnalyticsWorkspaceId: map['logAnalyticsWorkspaceId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      sharepointEnabled: map['sharepointEnabled'] == null ? null : map['sharepointEnabled'] as bool,
