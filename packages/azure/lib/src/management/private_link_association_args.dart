...
class PrivateLinkAssociationArgs {
  ...
  PrivateLinkAssociationArgs({
    ...
    String? name,
    required bool publicNetworkAccessEnabled,
    required String resourceManagementPrivateLinkId,
  }) :
  ...
  factory PrivateLinkAssociationArgs.fromMap(Map<String, dynamic> map) {
    return PrivateLinkAssociationArgs(
      ...
      resourceManagementPrivateLinkId: map['resourceManagementPrivateLinkId'] as String,
    );
  }
}
