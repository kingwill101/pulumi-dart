...
class GroupPolicyAssignmentArgs {
  ...
  GroupPolicyAssignmentArgs({
    ...
    String? displayName,
    bool? enforce,
    GroupPolicyAssignmentIdentity? identity,
    String? location,
    required String managementGroupId,
    String? metadata,
    String? name,
    List<GroupPolicyAssignmentNonComplianceMessage>? nonComplianceMessages,
    List<String>? notScopes,
    List<GroupPolicyAssignmentOverride>? overrides,
    String? parameters,
    required String policyDefinitionId,
    List<GroupPolicyAssignmentResourceSelector>? resourceSelectors,
  }) :
  ...
  factory GroupPolicyAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return GroupPolicyAssignmentArgs(
      ...
      identity: map['identity'] == null ? null : GroupPolicyAssignmentIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      nonComplianceMessages: map['nonComplianceMessages'] == null ? null : pulumi.Input.decodeList<GroupPolicyAssignmentNonComplianceMessage>(map['nonComplianceMessages'], (value) => GroupPolicyAssignmentNonComplianceMessage.fromMap((value as Map).cast<String, dynamic>())),
      notScopes: map['notScopes'] == null ? null : (map['notScopes'] as List).cast<String>(),
      overrides: map['overrides'] == null ? null : pulumi.Input.decodeList<GroupPolicyAssignmentOverride>(map['overrides'], (value) => GroupPolicyAssignmentOverride.fromMap((value as Map).cast<String, dynamic>())),
      parameters: map['parameters'] == null ? null : map['parameters'] as String,
      policyDefinitionId: map['policyDefinitionId'] as String,
      resourceSelectors: map['resourceSelectors'] == null ? null : pulumi.Input.decodeList<GroupPolicyAssignmentResourceSelector>(map['resourceSelectors'], (value) => GroupPolicyAssignmentResourceSelector.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
