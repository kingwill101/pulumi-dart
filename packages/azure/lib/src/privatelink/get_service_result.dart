...
class GetServiceResult {
  ...
  factory GetServiceResult.fromMap(Map<String, dynamic> map) {
    return GetServiceResult(
      ...
      autoApprovalSubscriptionIds: (map['autoApprovalSubscriptionIds'] as List).cast<String>(),
      enableProxyProtocol: map['enableProxyProtocol'] as bool,
      id: map['id'] as String,
      loadBalancerFrontendIpConfigurationIds: (map['loadBalancerFrontendIpConfigurationIds'] as List).cast<String>(),
