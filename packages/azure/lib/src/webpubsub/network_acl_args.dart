...
class NetworkAclArgs {
  ...
  NetworkAclArgs({
    ...
    List<NetworkAclPrivateEndpoint>? privateEndpoints,
    required NetworkAclPublicNetwork publicNetwork,
  ...
  factory NetworkAclArgs.fromMap(Map<String, dynamic> map) {
    return NetworkAclArgs(
      ...
      privateEndpoints: map['privateEndpoints'] == null ? null : pulumi.Input.decodeList<NetworkAclPrivateEndpoint>(map['privateEndpoints'], (value) => NetworkAclPrivateEndpoint.fromMap((value as Map).cast<String, dynamic>())),
      publicNetwork: NetworkAclPublicNetwork.fromMap((map['publicNetwork'] as Map).cast<String, dynamic>()),
