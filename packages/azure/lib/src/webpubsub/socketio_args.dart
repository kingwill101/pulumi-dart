...
class SocketioArgs {
  ...
  SocketioArgs({
    bool? aadAuthEnabled,
    SocketioIdentity? identity,
    bool? liveTraceConnectivityLogsEnabled,
    bool? liveTraceEnabled,
    bool? liveTraceHttpRequestLogsEnabled,
    bool? liveTraceMessagingLogsEnabled,
  ...
  factory SocketioArgs.fromMap(Map<String, dynamic> map) {
    return SocketioArgs(
      ...
      identity: map['identity'] == null ? null : SocketioIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      liveTraceConnectivityLogsEnabled: map['liveTraceConnectivityLogsEnabled'] == null ? null : map['liveTraceConnectivityLogsEnabled'] as bool,
      liveTraceEnabled: map['liveTraceEnabled'] == null ? null : map['liveTraceEnabled'] as bool,
      liveTraceHttpRequestLogsEnabled: map['liveTraceHttpRequestLogsEnabled'] == null ? null : map['liveTraceHttpRequestLogsEnabled'] as bool,
      liveTraceMessagingLogsEnabled: map['liveTraceMessagingLogsEnabled'] == null ? null : map['liveTraceMessagingLogsEnabled'] as bool,
      ...
      sku: SocketioSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
