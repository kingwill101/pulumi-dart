...
class HubArgs {
  ...
  HubArgs({
    bool? anonymousConnectionsEnabled,
    List<HubEventHandler>? eventHandlers,
    List<HubEventListener>? eventListeners,
    String? name,
  ...
  factory HubArgs.fromMap(Map<String, dynamic> map) {
    return HubArgs(
      anonymousConnectionsEnabled: map['anonymousConnectionsEnabled'] == null ? null : map['anonymousConnectionsEnabled'] as bool,
      eventHandlers: map['eventHandlers'] == null ? null : pulumi.Input.decodeList<HubEventHandler>(map['eventHandlers'], (value) => HubEventHandler.fromMap((value as Map).cast<String, dynamic>())),
      eventListeners: map['eventListeners'] == null ? null : pulumi.Input.decodeList<HubEventListener>(map['eventListeners'], (value) => HubEventListener.fromMap((value as Map).cast<String, dynamic>())),
