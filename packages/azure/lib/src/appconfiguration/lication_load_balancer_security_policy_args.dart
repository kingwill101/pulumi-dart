...
class LicationLoadBalancerSecurityPolicyArgs {
  ...
  LicationLoadBalancerSecurityPolicyArgs({
    required String applicationLoadBalancerId,
    String? location,
    String? name,
    Map<String, String>? tags,
    required String webApplicationFirewallPolicyId,
  }) :
  ...
  factory LicationLoadBalancerSecurityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return LicationLoadBalancerSecurityPolicyArgs(
      applicationLoadBalancerId: map['applicationLoadBalancerId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      webApplicationFirewallPolicyId: map['webApplicationFirewallPolicyId'] as String,
    );
  }
}
