...
class ConfigurationStoreArgs {
  ...
  ConfigurationStoreArgs({
    ...
    ConfigurationStoreEncryption? encryption,
    ConfigurationStoreIdentity? identity,
    bool? localAuthEnabled,
    String? location,
    String? name,
    String? publicNetworkAccess,
    bool? purgeProtectionEnabled,
    List<ConfigurationStoreReplica>? replicas,
  ...
  factory ConfigurationStoreArgs.fromMap(Map<String, dynamic> map) {
    return ConfigurationStoreArgs(
      dataPlaneProxyAuthenticationMode: map['dataPlaneProxyAuthenticationMode'] == null ? null : map['dataPlaneProxyAuthenticationMode'] as String,
      dataPlaneProxyPrivateLinkDelegationEnabled: map['dataPlaneProxyPrivateLinkDelegationEnabled'] == null ? null : map['dataPlaneProxyPrivateLinkDelegationEnabled'] as bool,
      encryption: map['encryption'] == null ? null : ConfigurationStoreEncryption.fromMap((map['encryption'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : ConfigurationStoreIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      replicas: map['replicas'] == null ? null : pulumi.Input.decodeList<ConfigurationStoreReplica>(map['replicas'], (value) => ConfigurationStoreReplica.fromMap((value as Map).cast<String, dynamic>())),
