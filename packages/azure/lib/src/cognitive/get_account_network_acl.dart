...
class GetAccountNetworkAcl {
  ...
  final List<GetAccountNetworkAclVirtualNetworkRule> virtualNetworkRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipRules': ipRules,
      'virtualNetworkRules': pulumi.Input.encodeList<GetAccountNetworkAclVirtualNetworkRule, Map<String, dynamic>>(virtualNetworkRules, (value) => value.toMap()),
    };
  }
  ...
  factory GetAccountNetworkAcl.fromMap(Map<String, dynamic> map) {
    return GetAccountNetworkAcl(
      ...
      virtualNetworkRules: pulumi.Input.decodeList<GetAccountNetworkAclVirtualNetworkRule>(map['virtualNetworkRules'], (value) => GetAccountNetworkAclVirtualNetworkRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
