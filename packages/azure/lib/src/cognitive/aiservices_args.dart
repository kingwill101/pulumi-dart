...
class AIServicesArgs {
  ...
  AIServicesArgs({
    ...
    AIServicesCustomerManagedKey? customerManagedKey,
    List<String>? fqdns,
    AIServicesIdentity? identity,
    bool? localAuthenticationEnabled,
    String? location,
    String? name,
    AIServicesNetworkAcls? networkAcls,
    bool? outboundNetworkAccessRestricted,
    String? publicNetworkAccess,
    required String resourceGroupName,
    required String skuName,
    List<AIServicesStorage>? storages,
  ...
  factory AIServicesArgs.fromMap(Map<String, dynamic> map) {
    return AIServicesArgs(
      ...
      customerManagedKey: map['customerManagedKey'] == null ? null : AIServicesCustomerManagedKey.fromMap((map['customerManagedKey'] as Map).cast<String, dynamic>()),
      fqdns: map['fqdns'] == null ? null : (map['fqdns'] as List).cast<String>(),
      identity: map['identity'] == null ? null : AIServicesIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      networkAcls: map['networkAcls'] == null ? null : AIServicesNetworkAcls.fromMap((map['networkAcls'] as Map).cast<String, dynamic>()),
      ...
      storages: map['storages'] == null ? null : pulumi.Input.decodeList<AIServicesStorage>(map['storages'], (value) => AIServicesStorage.fromMap((value as Map).cast<String, dynamic>())),
