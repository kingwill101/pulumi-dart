...
class AccountRaiPolicyArgs {
  ...
  AccountRaiPolicyArgs({
    required String basePolicyName,
    required String cognitiveAccountId,
    required List<AccountRaiPolicyContentFilter> contentFilters,
    String? mode,
    String? name,
  ...
  factory AccountRaiPolicyArgs.fromMap(Map<String, dynamic> map) {
    return AccountRaiPolicyArgs(
      basePolicyName: map['basePolicyName'] as String,
      cognitiveAccountId: map['cognitiveAccountId'] as String,
      contentFilters: pulumi.Input.decodeList<AccountRaiPolicyContentFilter>(map['contentFilters'], (value) => AccountRaiPolicyContentFilter.fromMap((value as Map).cast<String, dynamic>())),
