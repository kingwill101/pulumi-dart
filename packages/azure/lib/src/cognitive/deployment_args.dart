...
class DeploymentArgs {
  ...
  DeploymentArgs({
    ...
    required DeploymentModel model,
    String? name,
    String? raiPolicyName,
    required DeploymentSku sku,
  ...
  factory DeploymentArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentArgs(
      ...
      model: DeploymentModel.fromMap((map['model'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      raiPolicyName: map['raiPolicyName'] == null ? null : map['raiPolicyName'] as String,
      sku: DeploymentSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
