...
class Account extends pulumi.CustomResource {
  ...
  Account(
    ...
    this.customQuestionAnsweringSearchServiceId = registerOutput<String?>('customQuestionAnsweringSearchServiceId');
    this.customQuestionAnsweringSearchServiceKey = registerOutput<String?>('customQuestionAnsweringSearchServiceKey');
    ...
    this.metricsAdvisorAadClientId = registerOutput<String?>('metricsAdvisorAadClientId');
    this.metricsAdvisorAadTenantId = registerOutput<String?>('metricsAdvisorAadTenantId');
    this.metricsAdvisorSuperUserName = registerOutput<String?>('metricsAdvisorSuperUserName');
    this.metricsAdvisorWebsiteName = registerOutput<String?>('metricsAdvisorWebsiteName');
    this.name = registerOutput<String>('name');
    this.networkAcls = registerOutput<AccountNetworkAcls?>('networkAcls');
    this.networkInjection = registerOutput<AccountNetworkInjection?>('networkInjection');
