...
class RoleManagementPolicyArgs {
  ...
  RoleManagementPolicyArgs({
    RoleManagementPolicyActivationRules? activationRules,
    RoleManagementPolicyActiveAssignmentRules? activeAssignmentRules,
    RoleManagementPolicyEligibleAssignmentRules? eligibleAssignmentRules,
    RoleManagementPolicyNotificationRules? notificationRules,
  ...
  factory RoleManagementPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RoleManagementPolicyArgs(
      activationRules: map['activationRules'] == null ? null : RoleManagementPolicyActivationRules.fromMap((map['activationRules'] as Map).cast<String, dynamic>()),
      activeAssignmentRules: map['activeAssignmentRules'] == null ? null : RoleManagementPolicyActiveAssignmentRules.fromMap((map['activeAssignmentRules'] as Map).cast<String, dynamic>()),
      eligibleAssignmentRules: map['eligibleAssignmentRules'] == null ? null : RoleManagementPolicyEligibleAssignmentRules.fromMap((map['eligibleAssignmentRules'] as Map).cast<String, dynamic>()),
      notificationRules: map['notificationRules'] == null ? null : RoleManagementPolicyNotificationRules.fromMap((map['notificationRules'] as Map).cast<String, dynamic>()),
