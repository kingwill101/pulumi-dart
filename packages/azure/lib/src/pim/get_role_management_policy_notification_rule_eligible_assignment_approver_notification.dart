...
class GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification {
  ...
  /// Creates a new [GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification].
  ...
  factory GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification.fromMap(Map<String, dynamic> map) {
    return GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification(
