...
class GetRoleManagementPolicyActivationRule {
  ...
  final List<GetRoleManagementPolicyActivationRuleApprovalStage> approvalStages;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'approvalStages': pulumi.Input.encodeList<GetRoleManagementPolicyActivationRuleApprovalStage, Map<String, dynamic>>(approvalStages, (value) => value.toMap()),
  ...
  factory GetRoleManagementPolicyActivationRule.fromMap(Map<String, dynamic> map) {
    return GetRoleManagementPolicyActivationRule(
      approvalStages: pulumi.Input.decodeList<GetRoleManagementPolicyActivationRuleApprovalStage>(map['approvalStages'], (value) => GetRoleManagementPolicyActivationRuleApprovalStage.fromMap((value as Map).cast<String, dynamic>())),
      maximumDuration: map['maximumDuration'] as String,
      ...
      requiredConditionalAccessAuthenticationContext: map['requiredConditionalAccessAuthenticationContext'] as String,
    );
  }
}
