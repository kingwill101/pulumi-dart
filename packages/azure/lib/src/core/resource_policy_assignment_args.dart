...
class ResourcePolicyAssignmentArgs {
  ...
  ResourcePolicyAssignmentArgs({
    ...
    String? displayName,
    bool? enforce,
    ResourcePolicyAssignmentIdentity? identity,
    String? location,
    String? metadata,
    String? name,
    List<ResourcePolicyAssignmentNonComplianceMessage>? nonComplianceMessages,
    List<String>? notScopes,
    List<ResourcePolicyAssignmentOverride>? overrides,
    String? parameters,
    required String policyDefinitionId,
    required String resourceId,
    List<ResourcePolicyAssignmentResourceSelector>? resourceSelectors,
  }) :
  ...
  factory ResourcePolicyAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyAssignmentArgs(
      ...
      identity: map['identity'] == null ? null : ResourcePolicyAssignmentIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      metadata: map['metadata'] == null ? null : map['metadata'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      nonComplianceMessages: map['nonComplianceMessages'] == null ? null : pulumi.Input.decodeList<ResourcePolicyAssignmentNonComplianceMessage>(map['nonComplianceMessages'], (value) => ResourcePolicyAssignmentNonComplianceMessage.fromMap((value as Map).cast<String, dynamic>())),
      notScopes: map['notScopes'] == null ? null : (map['notScopes'] as List).cast<String>(),
      overrides: map['overrides'] == null ? null : pulumi.Input.decodeList<ResourcePolicyAssignmentOverride>(map['overrides'], (value) => ResourcePolicyAssignmentOverride.fromMap((value as Map).cast<String, dynamic>())),
      parameters: map['parameters'] == null ? null : map['parameters'] as String,
      policyDefinitionId: map['policyDefinitionId'] as String,
      resourceId: map['resourceId'] as String,
      resourceSelectors: map['resourceSelectors'] == null ? null : pulumi.Input.decodeList<ResourcePolicyAssignmentResourceSelector>(map['resourceSelectors'], (value) => ResourcePolicyAssignmentResourceSelector.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
