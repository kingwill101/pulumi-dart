...
class ResourceDeploymentScriptAzureCliArgs {
  ...
  ResourceDeploymentScriptAzureCliArgs({
    ...
    List<ResourceDeploymentScriptAzureCliEnvironmentVariable>? environmentVariables,
    String? forceUpdateTag,
    ResourceDeploymentScriptAzureCliIdentity? identity,
    String? location,
    String? name,
    ...
    ResourceDeploymentScriptAzureCliStorageAccount? storageAccount,
  ...
  factory ResourceDeploymentScriptAzureCliArgs.fromMap(Map<String, dynamic> map) {
    return ResourceDeploymentScriptAzureCliArgs(
      ...
      container: map['container'] == null ? null : ResourceDeploymentScriptAzureCliContainer.fromMap((map['container'] as Map).cast<String, dynamic>()),
      environmentVariables: map['environmentVariables'] == null ? null : pulumi.Input.decodeList<ResourceDeploymentScriptAzureCliEnvironmentVariable>(map['environmentVariables'], (value) => ResourceDeploymentScriptAzureCliEnvironmentVariable.fromMap((value as Map).cast<String, dynamic>())),
      forceUpdateTag: map['forceUpdateTag'] == null ? null : map['forceUpdateTag'] as String,
      identity: map['identity'] == null ? null : ResourceDeploymentScriptAzureCliIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      storageAccount: map['storageAccount'] == null ? null : ResourceDeploymentScriptAzureCliStorageAccount.fromMap((map['storageAccount'] as Map).cast<String, dynamic>()),
