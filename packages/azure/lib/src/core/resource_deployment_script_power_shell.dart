...
class ResourceDeploymentScriptPowerShell extends pulumi.CustomResource {
  ...
  ResourceDeploymentScriptPowerShell(
    ...
    this.container = registerOutput<ResourceDeploymentScriptPowerShellContainer?>('container');
    this.environmentVariables = registerOutput<List<ResourceDeploymentScriptPowerShellEnvironmentVariable>?>('environmentVariables');
    this.forceUpdateTag = registerOutput<String?>('forceUpdateTag');
    this.identity = registerOutput<ResourceDeploymentScriptPowerShellIdentity?>('identity');
    ...
    this.storageAccount = registerOutput<ResourceDeploymentScriptPowerShellStorageAccount?>('storageAccount');
