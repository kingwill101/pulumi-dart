...
class SubscriptionCostManagementExportArgs {
  ...
  SubscriptionCostManagementExportArgs({
    bool? active,
    required SubscriptionCostManagementExportExportDataOptions exportDataOptions,
    required SubscriptionCostManagementExportExportDataStorageLocation exportDataStorageLocation,
    String? fileFormat,
    String? name,
  ...
  factory SubscriptionCostManagementExportArgs.fromMap(Map<String, dynamic> map) {
    return SubscriptionCostManagementExportArgs(
      ...
      exportDataOptions: SubscriptionCostManagementExportExportDataOptions.fromMap((map['exportDataOptions'] as Map).cast<String, dynamic>()),
      exportDataStorageLocation: SubscriptionCostManagementExportExportDataStorageLocation.fromMap((map['exportDataStorageLocation'] as Map).cast<String, dynamic>()),
