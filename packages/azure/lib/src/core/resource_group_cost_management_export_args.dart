...
class ResourceGroupCostManagementExportArgs {
  ...
  ResourceGroupCostManagementExportArgs({
    bool? active,
    required ResourceGroupCostManagementExportExportDataOptions exportDataOptions,
    required ResourceGroupCostManagementExportExportDataStorageLocation exportDataStorageLocation,
    String? fileFormat,
    String? name,
  ...
  factory ResourceGroupCostManagementExportArgs.fromMap(Map<String, dynamic> map) {
    return ResourceGroupCostManagementExportArgs(
      ...
      exportDataOptions: ResourceGroupCostManagementExportExportDataOptions.fromMap((map['exportDataOptions'] as Map).cast<String, dynamic>()),
      exportDataStorageLocation: ResourceGroupCostManagementExportExportDataStorageLocation.fromMap((map['exportDataStorageLocation'] as Map).cast<String, dynamic>()),
