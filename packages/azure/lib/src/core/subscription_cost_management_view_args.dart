...
class SubscriptionCostManagementViewArgs {
  ...
  SubscriptionCostManagementViewArgs({
    ...
    required SubscriptionCostManagementViewDataset dataset,
    required String displayName,
    List<SubscriptionCostManagementViewKpi>? kpis,
    String? name,
    List<SubscriptionCostManagementViewPivot>? pivots,
  ...
  factory SubscriptionCostManagementViewArgs.fromMap(Map<String, dynamic> map) {
    return SubscriptionCostManagementViewArgs(
      ...
      dataset: SubscriptionCostManagementViewDataset.fromMap((map['dataset'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      kpis: map['kpis'] == null ? null : pulumi.Input.decodeList<SubscriptionCostManagementViewKpi>(map['kpis'], (value) => SubscriptionCostManagementViewKpi.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      pivots: map['pivots'] == null ? null : pulumi.Input.decodeList<SubscriptionCostManagementViewPivot>(map['pivots'], (value) => SubscriptionCostManagementViewPivot.fromMap((value as Map).cast<String, dynamic>())),
