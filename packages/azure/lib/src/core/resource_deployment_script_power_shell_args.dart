...
/// {@template pulumi_core_resource_deployment_script_power_shell_resource_deployment_script_power_shell_args_doc}
/// The set of arguments for ResourceDeploymentScriptPowerShell.
/// {@endtemplate}
...
class ResourceDeploymentScriptPowerShellArgs {
  ...
  /// Creates a new [ResourceDeploymentScriptPowerShellArgs].
  ...
  ResourceDeploymentScriptPowerShellArgs({
    ...
    String? commandLine,
    ResourceDeploymentScriptPowerShellContainer? container,
    List<ResourceDeploymentScriptPowerShellEnvironmentVariable>? environmentVariables,
    String? forceUpdateTag,
    ResourceDeploymentScriptPowerShellIdentity? identity,
    String? location,
    String? name,
    ...
    ResourceDeploymentScriptPowerShellStorageAccount? storageAccount,
  ...
  factory ResourceDeploymentScriptPowerShellArgs.fromMap(Map<String, dynamic> map) {
    return ResourceDeploymentScriptPowerShellArgs(
      ...
      container: map['container'] == null ? null : ResourceDeploymentScriptPowerShellContainer.fromMap((map['container'] as Map).cast<String, dynamic>()),
      environmentVariables: map['environmentVariables'] == null ? null : pulumi.Input.decodeList<ResourceDeploymentScriptPowerShellEnvironmentVariable>(map['environmentVariables'], (value) => ResourceDeploymentScriptPowerShellEnvironmentVariable.fromMap((value as Map).cast<String, dynamic>())),
      forceUpdateTag: map['forceUpdateTag'] == null ? null : map['forceUpdateTag'] as String,
      identity: map['identity'] == null ? null : ResourceDeploymentScriptPowerShellIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      storageAccount: map['storageAccount'] == null ? null : ResourceDeploymentScriptPowerShellStorageAccount.fromMap((map['storageAccount'] as Map).cast<String, dynamic>()),
