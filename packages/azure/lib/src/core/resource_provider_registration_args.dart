...
class ResourceProviderRegistrationArgs {
  ...
  ResourceProviderRegistrationArgs({
    List<ResourceProviderRegistrationFeature>? features,
    String? name,
  }) :
  ...
  factory ResourceProviderRegistrationArgs.fromMap(Map<String, dynamic> map) {
    return ResourceProviderRegistrationArgs(
      features: map['features'] == null ? null : pulumi.Input.decodeList<ResourceProviderRegistrationFeature>(map['features'], (value) => ResourceProviderRegistrationFeature.fromMap((value as Map).cast<String, dynamic>())),
