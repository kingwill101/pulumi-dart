...
class ResourcePolicyAssignment extends pulumi.CustomResource {
  ...
  ResourcePolicyAssignment(
    ...
    this.identity = registerOutput<ResourcePolicyAssignmentIdentity?>('identity');
    this.location = registerOutput<String>('location');
    this.metadata = registerOutput<String>('metadata');
    this.name = registerOutput<String>('name');
    this.nonComplianceMessages = registerOutput<List<ResourcePolicyAssignmentNonComplianceMessage>?>('nonComplianceMessages');
    this.notScopes = registerOutput<List<String>?>('notScopes');
    this.overrides = registerOutput<List<ResourcePolicyAssignmentOverride>?>('overrides');
    ...
    this.resourceSelectors = registerOutput<List<ResourcePolicyAssignmentResourceSelector>?>('resourceSelectors');
  }
}
