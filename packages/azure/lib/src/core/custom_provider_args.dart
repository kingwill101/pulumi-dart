...
class CustomProviderArgs {
  ...
  CustomProviderArgs({
    List<CustomProviderAction>? actions,
    String? location,
    String? name,
    required String resourceGroupName,
    List<CustomProviderResourceType>? resourceTypes,
    Map<String, String>? tags,
    List<CustomProviderValidation>? validations,
  }) :
  ...
  factory CustomProviderArgs.fromMap(Map<String, dynamic> map) {
    return CustomProviderArgs(
      actions: map['actions'] == null ? null : pulumi.Input.decodeList<CustomProviderAction>(map['actions'], (value) => CustomProviderAction.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      resourceTypes: map['resourceTypes'] == null ? null : pulumi.Input.decodeList<CustomProviderResourceType>(map['resourceTypes'], (value) => CustomProviderResourceType.fromMap((value as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      validations: map['validations'] == null ? null : pulumi.Input.decodeList<CustomProviderValidation>(map['validations'], (value) => CustomProviderValidation.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
