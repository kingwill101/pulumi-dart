...
class CacheNfsTargetArgs {
  ...
  CacheNfsTargetArgs({
    ...
    String? name,
    required List<CacheNfsTargetNamespaceJunction> namespaceJunctions,
    required String resourceGroupName,
    required String targetHostName,
    required String usageModel,
    int? verificationTimerInSeconds,
    int? writeBackTimerInSeconds,
  }) :
      cacheName = pulumi.Input.asInput<String>(cacheName),
      name = pulumi.Input.asOptionalInput<String>(name),
      namespaceJunctions = pulumi.Input.asInput<List<CacheNfsTargetNamespaceJunction>>(namespaceJunctions),
      resourceGroupName = pulumi.Input.asInput<String>(resourceGroupName),
      targetHostName = pulumi.Input.asInput<String>(targetHostName),
  ...
  factory CacheNfsTargetArgs.fromMap(Map<String, dynamic> map) {
    return CacheNfsTargetArgs(
      ...
      namespaceJunctions: pulumi.Input.decodeList<CacheNfsTargetNamespaceJunction>(map['namespaceJunctions'], (value) => CacheNfsTargetNamespaceJunction.fromMap((value as Map).cast<String, dynamic>())),
      resourceGroupName: map['resourceGroupName'] as String,
      targetHostName: map['targetHostName'] as String,
      usageModel: map['usageModel'] as String,
      verificationTimerInSeconds: map['verificationTimerInSeconds'] == null ? null : map['verificationTimerInSeconds'] as int,
      writeBackTimerInSeconds: map['writeBackTimerInSeconds'] == null ? null : map['writeBackTimerInSeconds'] as int,
    );
  }
}
