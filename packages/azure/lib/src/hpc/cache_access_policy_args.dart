...
class CacheAccessPolicyArgs {
  ...
  CacheAccessPolicyArgs({
    required List<CacheAccessPolicyAccessRule> accessRules,
    required String hpcCacheId,
    String? name,
  }) :
  ...
  factory CacheAccessPolicyArgs.fromMap(Map<String, dynamic> map) {
    return CacheAccessPolicyArgs(
      accessRules: pulumi.Input.decodeList<CacheAccessPolicyAccessRule>(map['accessRules'], (value) => CacheAccessPolicyAccessRule.fromMap((value as Map).cast<String, dynamic>())),
      hpcCacheId: map['hpcCacheId'] as String,
