...
class CacheArgs {
  ...
  CacheArgs({
    bool? automaticallyRotateKeyToLatestEnabled,
    required int cacheSizeInGb,
    CacheDefaultAccessPolicy? defaultAccessPolicy,
    CacheDirectoryActiveDirectory? directoryActiveDirectory,
    CacheDirectoryFlatFile? directoryFlatFile,
    CacheDirectoryLdap? directoryLdap,
    CacheDns? dns,
    ...
    Map<String, String>? tags,
      ...
      cacheSizeInGb = pulumi.Input.asInput<int>(cacheSizeInGb),
  ...
  factory CacheArgs.fromMap(Map<String, dynamic> map) {
    return CacheArgs(
      automaticallyRotateKeyToLatestEnabled: map['automaticallyRotateKeyToLatestEnabled'] == null ? null : map['automaticallyRotateKeyToLatestEnabled'] as bool,
      cacheSizeInGb: map['cacheSizeInGb'] as int,
      defaultAccessPolicy: map['defaultAccessPolicy'] == null ? null : CacheDefaultAccessPolicy.fromMap((map['defaultAccessPolicy'] as Map).cast<String, dynamic>()),
      directoryActiveDirectory: map['directoryActiveDirectory'] == null ? null : CacheDirectoryActiveDirectory.fromMap((map['directoryActiveDirectory'] as Map).cast<String, dynamic>()),
      directoryFlatFile: map['directoryFlatFile'] == null ? null : CacheDirectoryFlatFile.fromMap((map['directoryFlatFile'] as Map).cast<String, dynamic>()),
      directoryLdap: map['directoryLdap'] == null ? null : CacheDirectoryLdap.fromMap((map['directoryLdap'] as Map).cast<String, dynamic>()),
      dns: map['dns'] == null ? null : CacheDns.fromMap((map['dns'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : CacheIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
