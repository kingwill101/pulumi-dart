...
class ContainerImmutabilityPolicyArgs {
  ...
  ContainerImmutabilityPolicyArgs({
    required int immutabilityPeriodInDays,
    bool? locked,
    bool? protectedAppendWritesAllEnabled,
    bool? protectedAppendWritesEnabled,
    required String storageContainerResourceManagerId,
  }) :
  ...
  factory ContainerImmutabilityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ContainerImmutabilityPolicyArgs(
      immutabilityPeriodInDays: map['immutabilityPeriodInDays'] as int,
      locked: map['locked'] == null ? null : map['locked'] as bool,
      protectedAppendWritesAllEnabled: map['protectedAppendWritesAllEnabled'] == null ? null : map['protectedAppendWritesAllEnabled'] as bool,
      protectedAppendWritesEnabled: map['protectedAppendWritesEnabled'] == null ? null : map['protectedAppendWritesEnabled'] as bool,
      storageContainerResourceManagerId: map['storageContainerResourceManagerId'] as String,
    );
  }
}
