...
class DataLakeGen2PathArgs {
  ...
  factory DataLakeGen2PathArgs.fromMap(Map<String, dynamic> map) {
    return DataLakeGen2PathArgs(
      aces: map['aces'] == null ? null : pulumi.Input.decodeList<DataLakeGen2PathAce>(map['aces'], (value) => DataLakeGen2PathAce.fromMap((value as Map).cast<String, dynamic>())),
