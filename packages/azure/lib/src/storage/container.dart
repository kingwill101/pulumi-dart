...
class Container extends pulumi.CustomResource {
  ...
  Container(
    ...
    this.containerAccessType = registerOutput<String?>('containerAccessType');
    this.defaultEncryptionScope = registerOutput<String>('defaultEncryptionScope');
    this.encryptionScopeOverrideEnabled = registerOutput<bool?>('encryptionScopeOverrideEnabled');
