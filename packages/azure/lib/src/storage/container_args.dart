...
class ContainerArgs {
  ...
  factory ContainerArgs.fromMap(Map<String, dynamic> map) {
    return ContainerArgs(
      containerAccessType: map['containerAccessType'] == null ? null : map['containerAccessType'] as String,
      defaultEncryptionScope: map['defaultEncryptionScope'] == null ? null : map['defaultEncryptionScope'] as String,
      encryptionScopeOverrideEnabled: map['encryptionScopeOverrideEnabled'] == null ? null : map['encryptionScopeOverrideEnabled'] as bool,
