...
class DataLakeGen2FilesystemArgs {
  ...
  DataLakeGen2FilesystemArgs({
    List<DataLakeGen2FilesystemAce>? aces,
  ...
  factory DataLakeGen2FilesystemArgs.fromMap(Map<String, dynamic> map) {
    return DataLakeGen2FilesystemArgs(
      aces: map['aces'] == null ? null : pulumi.Input.decodeList<DataLakeGen2FilesystemAce>(map['aces'], (value) => DataLakeGen2FilesystemAce.fromMap((value as Map).cast<String, dynamic>())),
