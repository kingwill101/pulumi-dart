...
class MoverAgentArgs {
  ...
  MoverAgentArgs({
    required String arcVirtualMachineId,
    required String arcVirtualMachineUuid,
    String? description,
    String? name,
  ...
  factory MoverAgentArgs.fromMap(Map<String, dynamic> map) {
    return MoverAgentArgs(
      arcVirtualMachineId: map['arcVirtualMachineId'] as String,
      arcVirtualMachineUuid: map['arcVirtualMachineUuid'] as String,
