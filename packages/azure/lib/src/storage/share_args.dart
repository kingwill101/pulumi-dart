...
class ShareArgs {
  ...
  factory ShareArgs.fromMap(Map<String, dynamic> map) {
    return ShareArgs(
      ...
      acls: map['acls'] == null ? null : pulumi.Input.decodeList<ShareAcl>(map['acls'], (value) => ShareAcl.fromMap((value as Map).cast<String, dynamic>())),
      enabledProtocol: map['enabledProtocol'] == null ? null : map['enabledProtocol'] as String,
