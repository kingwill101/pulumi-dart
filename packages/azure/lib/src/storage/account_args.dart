...
class AccountArgs {
  ...
  AccountArgs({
    String? accessTier,
    String? accountKind,
    required String accountReplicationType,
    required String accountTier,
    bool? allowNestedItemsToBePublic,
    String? allowedCopyScope,
    AccountAzureFilesAuthentication? azureFilesAuthentication,
    AccountBlobProperties? blobProperties,
    bool? crossTenantReplicationEnabled,
    AccountCustomDomain? customDomain,
    ...
    AccountImmutabilityPolicy? immutabilityPolicy,
    bool? infrastructureEncryptionEnabled,
    bool? isHnsEnabled,
    bool? largeFileShareEnabled,
    bool? localUserEnabled,
    String? location,
    String? minTlsVersion,
    String? name,
    AccountNetworkRules? networkRules,
    bool? nfsv3Enabled,
    String? provisionedBillingModelVersion,
    bool? publicNetworkAccessEnabled,
    String? queueEncryptionKeyType,
    AccountQueueProperties? queueProperties,
    required String resourceGroupName,
    AccountRouting? routing,
    AccountSasPolicy? sasPolicy,
    bool? sftpEnabled,
    AccountShareProperties? shareProperties,
    bool? sharedAccessKeyEnabled,
    AccountStaticWebsite? staticWebsite,
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      ...
      accountKind: map['accountKind'] == null ? null : map['accountKind'] as String,
      accountReplicationType: map['accountReplicationType'] as String,
      accountTier: map['accountTier'] as String,
      allowNestedItemsToBePublic: map['allowNestedItemsToBePublic'] == null ? null : map['allowNestedItemsToBePublic'] as bool,
      allowedCopyScope: map['allowedCopyScope'] == null ? null : map['allowedCopyScope'] as String,
      azureFilesAuthentication: map['azureFilesAuthentication'] == null ? null : AccountAzureFilesAuthentication.fromMap((map['azureFilesAuthentication'] as Map).cast<String, dynamic>()),
      blobProperties: map['blobProperties'] == null ? null : AccountBlobProperties.fromMap((map['blobProperties'] as Map).cast<String, dynamic>()),
      crossTenantReplicationEnabled: map['crossTenantReplicationEnabled'] == null ? null : map['crossTenantReplicationEnabled'] as bool,
      customDomain: map['customDomain'] == null ? null : AccountCustomDomain.fromMap((map['customDomain'] as Map).cast<String, dynamic>()),
      ...
      httpsTrafficOnlyEnabled: map['httpsTrafficOnlyEnabled'] == null ? null : map['httpsTrafficOnlyEnabled'] as bool,
      identity: map['identity'] == null ? null : AccountIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      immutabilityPolicy: map['immutabilityPolicy'] == null ? null : AccountImmutabilityPolicy.fromMap((map['immutabilityPolicy'] as Map).cast<String, dynamic>()),
      ...
      largeFileShareEnabled: map['largeFileShareEnabled'] == null ? null : map['largeFileShareEnabled'] as bool,
      localUserEnabled: map['localUserEnabled'] == null ? null : map['localUserEnabled'] as bool,
      location: map['location'] == null ? null : map['location'] as String,
      minTlsVersion: map['minTlsVersion'] == null ? null : map['minTlsVersion'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkRules: map['networkRules'] == null ? null : AccountNetworkRules.fromMap((map['networkRules'] as Map).cast<String, dynamic>()),
      nfsv3Enabled: map['nfsv3Enabled'] == null ? null : map['nfsv3Enabled'] as bool,
      provisionedBillingModelVersion: map['provisionedBillingModelVersion'] == null ? null : map['provisionedBillingModelVersion'] as String,
      publicNetworkAccessEnabled: map['publicNetworkAccessEnabled'] == null ? null : map['publicNetworkAccessEnabled'] as bool,
      queueEncryptionKeyType: map['queueEncryptionKeyType'] == null ? null : map['queueEncryptionKeyType'] as String,
      queueProperties: map['queueProperties'] == null ? null : AccountQueueProperties.fromMap((map['queueProperties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      routing: map['routing'] == null ? null : AccountRouting.fromMap((map['routing'] as Map).cast<String, dynamic>()),
      sasPolicy: map['sasPolicy'] == null ? null : AccountSasPolicy.fromMap((map['sasPolicy'] as Map).cast<String, dynamic>()),
      sftpEnabled: map['sftpEnabled'] == null ? null : map['sftpEnabled'] as bool,
      shareProperties: map['shareProperties'] == null ? null : AccountShareProperties.fromMap((map['shareProperties'] as Map).cast<String, dynamic>()),
      sharedAccessKeyEnabled: map['sharedAccessKeyEnabled'] == null ? null : map['sharedAccessKeyEnabled'] as bool,
      staticWebsite: map['staticWebsite'] == null ? null : AccountStaticWebsite.fromMap((map['staticWebsite'] as Map).cast<String, dynamic>()),
      tableEncryptionKeyType: map['tableEncryptionKeyType'] == null ? null : map['tableEncryptionKeyType'] as String,
