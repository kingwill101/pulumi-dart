...
class EncryptionScopeArgs {
  ...
  EncryptionScopeArgs({
    bool? infrastructureEncryptionRequired,
  ...
  factory EncryptionScopeArgs.fromMap(Map<String, dynamic> map) {
    return EncryptionScopeArgs(
      infrastructureEncryptionRequired: map['infrastructureEncryptionRequired'] == null ? null : map['infrastructureEncryptionRequired'] as bool,
