...
class ObjectReplicationArgs {
  ...
  ObjectReplicationArgs({
    required String destinationStorageAccountId,
    required List<ObjectReplicationRule> rules,
    required String sourceStorageAccountId,
  }) :
  ...
  factory ObjectReplicationArgs.fromMap(Map<String, dynamic> map) {
    return ObjectReplicationArgs(
      destinationStorageAccountId: map['destinationStorageAccountId'] as String,
      rules: pulumi.Input.decodeList<ObjectReplicationRule>(map['rules'], (value) => ObjectReplicationRule.fromMap((value as Map).cast<String, dynamic>())),
      sourceStorageAccountId: map['sourceStorageAccountId'] as String,
    );
  }
}
