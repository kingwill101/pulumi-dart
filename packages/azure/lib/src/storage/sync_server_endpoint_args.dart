...
class SyncServerEndpointArgs {
  ...
  SyncServerEndpointArgs({
    bool? cloudTieringEnabled,
    String? initialDownloadPolicy,
    String? localCacheMode,
    String? name,
    required String registeredServerId,
    required String serverLocalPath,
    required String storageSyncGroupId,
  ...
  factory SyncServerEndpointArgs.fromMap(Map<String, dynamic> map) {
    return SyncServerEndpointArgs(
      cloudTieringEnabled: map['cloudTieringEnabled'] == null ? null : map['cloudTieringEnabled'] as bool,
      ...
      registeredServerId: map['registeredServerId'] as String,
      serverLocalPath: map['serverLocalPath'] as String,
      storageSyncGroupId: map['storageSyncGroupId'] as String,
