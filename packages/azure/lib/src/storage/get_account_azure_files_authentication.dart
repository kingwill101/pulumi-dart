...
class GetAccountAzureFilesAuthentication {
  ...
  final List<GetAccountAzureFilesAuthenticationActiveDirectory> activeDirectories;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'activeDirectories': pulumi.Input.encodeList<GetAccountAzureFilesAuthenticationActiveDirectory, Map<String, dynamic>>(activeDirectories, (value) => value.toMap()),
  ...
  factory GetAccountAzureFilesAuthentication.fromMap(Map<String, dynamic> map) {
    return GetAccountAzureFilesAuthentication(
      activeDirectories: pulumi.Input.decodeList<GetAccountAzureFilesAuthenticationActiveDirectory>(map['activeDirectories'], (value) => GetAccountAzureFilesAuthenticationActiveDirectory.fromMap((value as Map).cast<String, dynamic>())),
      defaultShareLevelPermission: map['defaultShareLevelPermission'] as String,
