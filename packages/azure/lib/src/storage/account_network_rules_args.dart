...
class AccountNetworkRulesArgs {
  ...
  AccountNetworkRulesArgs({
    ...
    List<String>? ipRules,
    List<AccountNetworkRulesPrivateLinkAccessRule>? privateLinkAccessRules,
    required String storageAccountId,
    List<String>? virtualNetworkSubnetIds,
  }) :
  ...
  factory AccountNetworkRulesArgs.fromMap(Map<String, dynamic> map) {
    return AccountNetworkRulesArgs(
      bypasses: map['bypasses'] == null ? null : (map['bypasses'] as List).cast<String>(),
      defaultAction: map['defaultAction'] as String,
      ipRules: map['ipRules'] == null ? null : (map['ipRules'] as List).cast<String>(),
      privateLinkAccessRules: map['privateLinkAccessRules'] == null ? null : pulumi.Input.decodeList<AccountNetworkRulesPrivateLinkAccessRule>(map['privateLinkAccessRules'], (value) => AccountNetworkRulesPrivateLinkAccessRule.fromMap((value as Map).cast<String, dynamic>())),
