...
class AccountArgs {
  ...
  AccountArgs({
    List<String>? allowedAuthenticationModes,
    AccountEncryption? encryption,
    AccountIdentity? identity,
    AccountKeyVaultReference? keyVaultReference,
    String? location,
    String? name,
    AccountNetworkProfile? networkProfile,
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      allowedAuthenticationModes: map['allowedAuthenticationModes'] == null ? null : (map['allowedAuthenticationModes'] as List).cast<String>(),
      ...
      keyVaultReference: map['keyVaultReference'] == null ? null : AccountKeyVaultReference.fromMap((map['keyVaultReference'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkProfile: map['networkProfile'] == null ? null : AccountNetworkProfile.fromMap((map['networkProfile'] as Map).cast<String, dynamic>()),
      poolAllocationMode: map['poolAllocationMode'] == null ? null : map['poolAllocationMode'] as String,
      publicNetworkAccessEnabled: map['publicNetworkAccessEnabled'] == null ? null : map['publicNetworkAccessEnabled'] as bool,
      resourceGroupName: map['resourceGroupName'] as String,
      storageAccountAuthenticationMode: map['storageAccountAuthenticationMode'] == null ? null : map['storageAccountAuthenticationMode'] as String,
      storageAccountId: map['storageAccountId'] == null ? null : map['storageAccountId'] as String,
      storageAccountNodeIdentity: map['storageAccountNodeIdentity'] == null ? null : map['storageAccountNodeIdentity'] as String,
