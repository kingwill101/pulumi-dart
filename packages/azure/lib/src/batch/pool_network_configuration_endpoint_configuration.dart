...
class PoolNetworkConfigurationEndpointConfiguration {
  ...
  final List<PoolNetworkConfigurationEndpointConfigurationNetworkSecurityGroupRule>? networkSecurityGroupRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'networkSecurityGroupRules': ?networkSecurityGroupRules == null ? null : pulumi.Input.encodeList<PoolNetworkConfigurationEndpointConfigurationNetworkSecurityGroupRule, Map<String, dynamic>>(networkSecurityGroupRules!, (value) => value.toMap()),
      'protocol': protocol,
    };
  }
