...
/// {@template pulumi_batch_pool_pool_args_doc}
/// The set of arguments for Pool.
/// {@endtemplate}
/// {@macro pulumi_batch_pool_pool_args_doc}
class PoolArgs {
  ...
  PoolArgs({
    ...
    PoolAutoScale? autoScale,
    List<PoolCertificate>? certificates,
    PoolContainerConfiguration? containerConfiguration,
    List<PoolDataDisk>? dataDisks,
    List<PoolDiskEncryption>? diskEncryptions,
    String? displayName,
    List<PoolExtension>? extensions,
    PoolFixedScale? fixedScale,
    PoolIdentity? identity,
    String? interNodeCommunication,
    String? licenseType,
    int? maxTasksPerNode,
    Map<String, String>? metadata,
    List<PoolMount>? mounts,
    String? name,
    PoolNetworkConfiguration? networkConfiguration,
    required String nodeAgentSkuId,
    List<PoolNodePlacement>? nodePlacements,
    String? osDiskPlacement,
    required String resourceGroupName,
    PoolSecurityProfile? securityProfile,
    PoolStartTask? startTask,
    bool? stopPendingResizeOperation,
    required PoolStorageImageReference storageImageReference,
    String? targetNodeCommunicationMode,
    List<PoolTaskSchedulingPolicy>? taskSchedulingPolicies,
    List<PoolUserAccount>? userAccounts,
    required String vmSize,
    List<PoolWindow>? windows,
  }) :
      ...
      nodeAgentSkuId = pulumi.Input.asInput<String>(nodeAgentSkuId),
      ...
      storageImageReference = pulumi.Input.asInput<PoolStorageImageReference>(storageImageReference),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'storageImageReference': pulumi.Input.mapInputValue<PoolStorageImageReference, Map<String, dynamic>>(storageImageReference, (value) => value.toMap()),
  ...
  factory PoolArgs.fromMap(Map<String, dynamic> map) {
    return PoolArgs(
      ...
      autoScale: map['autoScale'] == null ? null : PoolAutoScale.fromMap((map['autoScale'] as Map).cast<String, dynamic>()),
      certificates: map['certificates'] == null ? null : pulumi.Input.decodeList<PoolCertificate>(map['certificates'], (value) => PoolCertificate.fromMap((value as Map).cast<String, dynamic>())),
      containerConfiguration: map['containerConfiguration'] == null ? null : PoolContainerConfiguration.fromMap((map['containerConfiguration'] as Map).cast<String, dynamic>()),
      dataDisks: map['dataDisks'] == null ? null : pulumi.Input.decodeList<PoolDataDisk>(map['dataDisks'], (value) => PoolDataDisk.fromMap((value as Map).cast<String, dynamic>())),
      diskEncryptions: map['diskEncryptions'] == null ? null : pulumi.Input.decodeList<PoolDiskEncryption>(map['diskEncryptions'], (value) => PoolDiskEncryption.fromMap((value as Map).cast<String, dynamic>())),
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      extensions: map['extensions'] == null ? null : pulumi.Input.decodeList<PoolExtension>(map['extensions'], (value) => PoolExtension.fromMap((value as Map).cast<String, dynamic>())),
      fixedScale: map['fixedScale'] == null ? null : PoolFixedScale.fromMap((map['fixedScale'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : PoolIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      maxTasksPerNode: map['maxTasksPerNode'] == null ? null : map['maxTasksPerNode'] as int,
      metadata: map['metadata'] == null ? null : (map['metadata'] as Map).cast<String, String>(),
      mounts: map['mounts'] == null ? null : pulumi.Input.decodeList<PoolMount>(map['mounts'], (value) => PoolMount.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      networkConfiguration: map['networkConfiguration'] == null ? null : PoolNetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>()),
      nodeAgentSkuId: map['nodeAgentSkuId'] as String,
      nodePlacements: map['nodePlacements'] == null ? null : pulumi.Input.decodeList<PoolNodePlacement>(map['nodePlacements'], (value) => PoolNodePlacement.fromMap((value as Map).cast<String, dynamic>())),
      osDiskPlacement: map['osDiskPlacement'] == null ? null : map['osDiskPlacement'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      securityProfile: map['securityProfile'] == null ? null : PoolSecurityProfile.fromMap((map['securityProfile'] as Map).cast<String, dynamic>()),
      startTask: map['startTask'] == null ? null : PoolStartTask.fromMap((map['startTask'] as Map).cast<String, dynamic>()),
      stopPendingResizeOperation: map['stopPendingResizeOperation'] == null ? null : map['stopPendingResizeOperation'] as bool,
      storageImageReference: PoolStorageImageReference.fromMap((map['storageImageReference'] as Map).cast<String, dynamic>()),
      targetNodeCommunicationMode: map['targetNodeCommunicationMode'] == null ? null : map['targetNodeCommunicationMode'] as String,
      taskSchedulingPolicies: map['taskSchedulingPolicies'] == null ? null : pulumi.Input.decodeList<PoolTaskSchedulingPolicy>(map['taskSchedulingPolicies'], (value) => PoolTaskSchedulingPolicy.fromMap((value as Map).cast<String, dynamic>())),
      userAccounts: map['userAccounts'] == null ? null : pulumi.Input.decodeList<PoolUserAccount>(map['userAccounts'], (value) => PoolUserAccount.fromMap((value as Map).cast<String, dynamic>())),
      vmSize: map['vmSize'] as String,
      windows: map['windows'] == null ? null : pulumi.Input.decodeList<PoolWindow>(map['windows'], (value) => PoolWindow.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
