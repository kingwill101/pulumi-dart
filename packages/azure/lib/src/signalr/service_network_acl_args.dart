...
class ServiceNetworkAclArgs {
  ...
  ServiceNetworkAclArgs({
    ...
    List<ServiceNetworkAclPrivateEndpoint>? privateEndpoints,
    required ServiceNetworkAclPublicNetwork publicNetwork,
  ...
  factory ServiceNetworkAclArgs.fromMap(Map<String, dynamic> map) {
    return ServiceNetworkAclArgs(
      ...
      privateEndpoints: map['privateEndpoints'] == null ? null : pulumi.Input.decodeList<ServiceNetworkAclPrivateEndpoint>(map['privateEndpoints'], (value) => ServiceNetworkAclPrivateEndpoint.fromMap((value as Map).cast<String, dynamic>())),
      publicNetwork: ServiceNetworkAclPublicNetwork.fromMap((map['publicNetwork'] as Map).cast<String, dynamic>()),
