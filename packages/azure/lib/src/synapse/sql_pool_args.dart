...
class SqlPoolArgs {
  ...
  SqlPoolArgs({
    ...
    String? createMode,
    bool? dataEncrypted,
    bool? geoBackupPolicyEnabled,
    String? name,
    String? recoveryDatabaseId,
    SqlPoolRestore? restore,
  ...
  factory SqlPoolArgs.fromMap(Map<String, dynamic> map) {
    return SqlPoolArgs(
      ...
      dataEncrypted: map['dataEncrypted'] == null ? null : map['dataEncrypted'] as bool,
      geoBackupPolicyEnabled: map['geoBackupPolicyEnabled'] == null ? null : map['geoBackupPolicyEnabled'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      recoveryDatabaseId: map['recoveryDatabaseId'] == null ? null : map['recoveryDatabaseId'] as String,
      restore: map['restore'] == null ? null : SqlPoolRestore.fromMap((map['restore'] as Map).cast<String, dynamic>()),
