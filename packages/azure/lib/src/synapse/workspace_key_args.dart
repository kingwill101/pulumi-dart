...
class WorkspaceKeyArgs {
  ...
  WorkspaceKeyArgs({
    ...
    required String customerManagedKeyName,
  ...
  factory WorkspaceKeyArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceKeyArgs(
      ...
      customerManagedKeyName: map['customerManagedKeyName'] as String,
      customerManagedKeyVersionlessId: map['customerManagedKeyVersionlessId'] == null ? null : map['customerManagedKeyVersionlessId'] as String,
