...
class SqlPoolWorkloadGroupArgs {
  ...
  SqlPoolWorkloadGroupArgs({
    ...
    String? name,
    int? queryExecutionTimeoutInSeconds,
  ...
  factory SqlPoolWorkloadGroupArgs.fromMap(Map<String, dynamic> map) {
    return SqlPoolWorkloadGroupArgs(
      ...
      minResourcePercentPerRequest: map['minResourcePercentPerRequest'] == null ? null : map['minResourcePercentPerRequest'] as double,
      name: map['name'] == null ? null : map['name'] as String,
      queryExecutionTimeoutInSeconds: map['queryExecutionTimeoutInSeconds'] == null ? null : map['queryExecutionTimeoutInSeconds'] as int,
