...
class RoleAssignmentArgs {
  ...
  factory RoleAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return RoleAssignmentArgs(
      ...
      synapseSparkPoolId: map['synapseSparkPoolId'] == null ? null : map['synapseSparkPoolId'] as String,
      synapseWorkspaceId: map['synapseWorkspaceId'] == null ? null : map['synapseWorkspaceId'] as String,
    );
  }
}
