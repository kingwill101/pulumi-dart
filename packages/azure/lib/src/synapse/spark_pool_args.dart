...
class SparkPoolArgs {
  ...
  /// [tags] Optional.
  SparkPoolArgs({
    SparkPoolAutoPause? autoPause,
    SparkPoolAutoScale? autoScale,
    int? cacheSize,
    bool? computeIsolationEnabled,
    bool? dynamicExecutorAllocationEnabled,
    SparkPoolLibraryRequirement? libraryRequirement,
    int? maxExecutors,
    int? minExecutors,
    String? name,
    int? nodeCount,
    required String nodeSize,
    required String nodeSizeFamily,
    bool? sessionLevelPackagesEnabled,
    SparkPoolSparkConfig? sparkConfig,
    String? sparkEventsFolder,
    String? sparkLogFolder,
    required String sparkVersion,
  ...
  factory SparkPoolArgs.fromMap(Map<String, dynamic> map) {
    return SparkPoolArgs(
      autoPause: map['autoPause'] == null ? null : SparkPoolAutoPause.fromMap((map['autoPause'] as Map).cast<String, dynamic>()),
      autoScale: map['autoScale'] == null ? null : SparkPoolAutoScale.fromMap((map['autoScale'] as Map).cast<String, dynamic>()),
      ...
      dynamicExecutorAllocationEnabled: map['dynamicExecutorAllocationEnabled'] == null ? null : map['dynamicExecutorAllocationEnabled'] as bool,
      libraryRequirement: map['libraryRequirement'] == null ? null : SparkPoolLibraryRequirement.fromMap((map['libraryRequirement'] as Map).cast<String, dynamic>()),
      maxExecutors: map['maxExecutors'] == null ? null : map['maxExecutors'] as int,
      minExecutors: map['minExecutors'] == null ? null : map['minExecutors'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      nodeCount: map['nodeCount'] == null ? null : map['nodeCount'] as int,
      nodeSize: map['nodeSize'] as String,
      nodeSizeFamily: map['nodeSizeFamily'] as String,
      sessionLevelPackagesEnabled: map['sessionLevelPackagesEnabled'] == null ? null : map['sessionLevelPackagesEnabled'] as bool,
      sparkConfig: map['sparkConfig'] == null ? null : SparkPoolSparkConfig.fromMap((map['sparkConfig'] as Map).cast<String, dynamic>()),
      sparkEventsFolder: map['sparkEventsFolder'] == null ? null : map['sparkEventsFolder'] as String,
      sparkLogFolder: map['sparkLogFolder'] == null ? null : map['sparkLogFolder'] as String,
      sparkVersion: map['sparkVersion'] as String,
