...
class ResourceBridgeApplianceArgs {
  ...
  ResourceBridgeApplianceArgs({
    ...
    required ResourceBridgeApplianceIdentity identity,
    required String infrastructureProvider,
    String? location,
    String? name,
  ...
  factory ResourceBridgeApplianceArgs.fromMap(Map<String, dynamic> map) {
    return ResourceBridgeApplianceArgs(
      ...
      identity: ResourceBridgeApplianceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      infrastructureProvider: map['infrastructureProvider'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      publicKeyBase64: map['publicKeyBase64'] == null ? null : map['publicKeyBase64'] as String,
