...
class ConfigurationArgs {
  ...
  ConfigurationArgs({
    ...
    ConfigurationInstallPatches? installPatches,
    String? location,
    String? name,
  ...
  factory ConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return ConfigurationArgs(
      inGuestUserPatchMode: map['inGuestUserPatchMode'] == null ? null : map['inGuestUserPatchMode'] as String,
      installPatches: map['installPatches'] == null ? null : ConfigurationInstallPatches.fromMap((map['installPatches'] as Map).cast<String, dynamic>()),
      ...
      window: map['window'] == null ? null : ConfigurationWindow.fromMap((map['window'] as Map).cast<String, dynamic>()),
    );
  }
}
