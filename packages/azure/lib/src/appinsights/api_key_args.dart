...
class ApiKeyArgs {
  ...
  factory ApiKeyArgs.fromMap(Map<String, dynamic> map) {
    return ApiKeyArgs(
      ...
      readPermissions: map['readPermissions'] == null ? null : (map['readPermissions'] as List).cast<String>(),
      writePermissions: map['writePermissions'] == null ? null : (map['writePermissions'] as List).cast<String>(),
    );
  }
}
