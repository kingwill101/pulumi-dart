...
class StandardWebTestArgs {
  ...
  StandardWebTestArgs({
    ...
    String? location,
    String? name,
    required StandardWebTestRequest request,
    required String resourceGroupName,
    bool? retryEnabled,
    Map<String, String>? tags,
    int? timeout,
    StandardWebTestValidationRules? validationRules,
  }) :
  ...
  factory StandardWebTestArgs.fromMap(Map<String, dynamic> map) {
    return StandardWebTestArgs(
      ...
      request: StandardWebTestRequest.fromMap((map['request'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      retryEnabled: map['retryEnabled'] == null ? null : map['retryEnabled'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeout: map['timeout'] == null ? null : map['timeout'] as int,
      validationRules: map['validationRules'] == null ? null : StandardWebTestValidationRules.fromMap((map['validationRules'] as Map).cast<String, dynamic>()),
    );
  }
}
