...
class ShareArgs {
  ...
  ShareArgs({
    ...
    String? name,
    ShareSnapshotSchedule? snapshotSchedule,
    String? terms,
  }) :
  ...
  factory ShareArgs.fromMap(Map<String, dynamic> map) {
    return ShareArgs(
      ...
      snapshotSchedule: map['snapshotSchedule'] == null ? null : ShareSnapshotSchedule.fromMap((map['snapshotSchedule'] as Map).cast<String, dynamic>()),
