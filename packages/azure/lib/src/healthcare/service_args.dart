...
class ServiceArgs {
  ...
  ServiceArgs({
    ...
    ServiceAuthenticationConfiguration? authenticationConfiguration,
    String? configurationExportStorageAccountName,
    ServiceCorsConfiguration? corsConfiguration,
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      ...
      authenticationConfiguration: map['authenticationConfiguration'] == null ? null : ServiceAuthenticationConfiguration.fromMap((map['authenticationConfiguration'] as Map).cast<String, dynamic>()),
      ...
      corsConfiguration: map['corsConfiguration'] == null ? null : ServiceCorsConfiguration.fromMap((map['corsConfiguration'] as Map).cast<String, dynamic>()),
      cosmosdbKeyVaultKeyVersionlessId: map['cosmosdbKeyVaultKeyVersionlessId'] == null ? null : map['cosmosdbKeyVaultKeyVersionlessId'] as String,
      cosmosdbThroughput: map['cosmosdbThroughput'] == null ? null : map['cosmosdbThroughput'] as int,
