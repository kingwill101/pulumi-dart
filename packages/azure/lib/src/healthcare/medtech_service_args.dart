...
class MedtechServiceArgs {
  ...
  MedtechServiceArgs({
    required String deviceMappingJson,
    required String eventhubConsumerGroupName,
    required String eventhubName,
    required String eventhubNamespaceName,
    MedtechServiceIdentity? identity,
    String? location,
    String? name,
  ...
  factory MedtechServiceArgs.fromMap(Map<String, dynamic> map) {
    return MedtechServiceArgs(
      ...
      identity: map['identity'] == null ? null : MedtechServiceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
