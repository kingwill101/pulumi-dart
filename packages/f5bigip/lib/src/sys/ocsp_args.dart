...
class OcspArgs {
  ...
  OcspArgs({
    ...
    String? signerKey,
    int? statusAge,
    String? strictRespCertCheck,
    String? trustedResponders,
  }) :
  ...
  factory OcspArgs.fromMap(Map<String, dynamic> map) {
    return OcspArgs(
      cacheErrorTimeout: map['cacheErrorTimeout'] == null ? null : map['cacheErrorTimeout'] as int,
      cacheTimeout: map['cacheTimeout'] == null ? null : map['cacheTimeout'] as String,
      clockSkew: map['clockSkew'] == null ? null : map['clockSkew'] as int,
      concurrentConnectionsLimit: map['concurrentConnectionsLimit'] == null ? null : map['concurrentConnectionsLimit'] as int,
      connectionTimeout: map['connectionTimeout'] == null ? null : map['connectionTimeout'] as int,
      dnsResolver: map['dnsResolver'] == null ? null : map['dnsResolver'] as String,
      name: map['name'] as String,
      passphrase: map['passphrase'] == null ? null : map['passphrase'] as String,
      proxyServerPool: map['proxyServerPool'] == null ? null : map['proxyServerPool'] as String,
      responderUrl: map['responderUrl'] == null ? null : map['responderUrl'] as String,
      routeDomain: map['routeDomain'] == null ? null : map['routeDomain'] as String,
      signHash: map['signHash'] == null ? null : map['signHash'] as String,
      signerCert: map['signerCert'] == null ? null : map['signerCert'] as String,
      signerKey: map['signerKey'] == null ? null : map['signerKey'] as String,
      statusAge: map['statusAge'] == null ? null : map['statusAge'] as int,
      strictRespCertCheck: map['strictRespCertCheck'] == null ? null : map['strictRespCertCheck'] as String,
      trustedResponders: map['trustedResponders'] == null ? null : map['trustedResponders'] as String,
    );
  }
}
