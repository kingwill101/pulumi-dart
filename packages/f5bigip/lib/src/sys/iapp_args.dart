...
class IAppArgs {
  ...
  IAppArgs({
    ...
    String? inheritedDevicegroup,
    String? inheritedTrafficGroup,
    required String jsonfile,
    List<IAppList>? lists,
    List<IAppMetadata>? metadatas,
    required String name,
    String? partition,
    String? strictUpdates,
    List<IAppTable>? tables,
    String? template,
    String? templateModified,
    String? templatePrerequisiteErrors,
    String? trafficGroup,
    List<IAppVariable>? variables,
  }) :
      ...
      jsonfile = pulumi.Input.asInput<String>(jsonfile),
  ...
  factory IAppArgs.fromMap(Map<String, dynamic> map) {
    return IAppArgs(
      ...
      devicegroup: map['devicegroup'] == null ? null : map['devicegroup'] as String,
      executeAction: map['executeAction'] == null ? null : map['executeAction'] as String,
      inheritedDevicegroup: map['inheritedDevicegroup'] == null ? null : map['inheritedDevicegroup'] as String,
      inheritedTrafficGroup: map['inheritedTrafficGroup'] == null ? null : map['inheritedTrafficGroup'] as String,
      jsonfile: map['jsonfile'] as String,
      lists: map['lists'] == null ? null : pulumi.Input.decodeList<IAppList>(map['lists'], (value) => IAppList.fromMap((value as Map).cast<String, dynamic>())),
      metadatas: map['metadatas'] == null ? null : pulumi.Input.decodeList<IAppMetadata>(map['metadatas'], (value) => IAppMetadata.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      partition: map['partition'] == null ? null : map['partition'] as String,
      strictUpdates: map['strictUpdates'] == null ? null : map['strictUpdates'] as String,
      tables: map['tables'] == null ? null : pulumi.Input.decodeList<IAppTable>(map['tables'], (value) => IAppTable.fromMap((value as Map).cast<String, dynamic>())),
      template: map['template'] == null ? null : map['template'] as String,
      templateModified: map['templateModified'] == null ? null : map['templateModified'] as String,
      templatePrerequisiteErrors: map['templatePrerequisiteErrors'] == null ? null : map['templatePrerequisiteErrors'] as String,
      trafficGroup: map['trafficGroup'] == null ? null : map['trafficGroup'] as String,
      variables: map['variables'] == null ? null : pulumi.Input.decodeList<IAppVariable>(map['variables'], (value) => IAppVariable.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
