...
class FastUdpAppArgs {
  ...
  FastUdpAppArgs({
    ...
    FastUdpAppMonitor? monitor,
    String? persistenceProfile,
    String? persistenceType,
    List<FastUdpAppPoolMember>? poolMembers,
    List<String>? securityLogProfiles,
    int? slowRampTime,
    List<String>? snatPoolAddresses,
    required String tenant,
    FastUdpAppVirtualServer? virtualServer,
    List<String>? vlansAlloweds,
    List<String>? vlansRejecteds,
  }) :
  ...
  factory FastUdpAppArgs.fromMap(Map<String, dynamic> map) {
    return FastUdpAppArgs(
      ...
      enableFastl4: map['enableFastl4'] == null ? null : map['enableFastl4'] as bool,
      ...
      existingProfile: map['existingProfile'] == null ? null : map['existingProfile'] as String,
      ...
      monitor: map['monitor'] == null ? null : FastUdpAppMonitor.fromMap((map['monitor'] as Map).cast<String, dynamic>()),
      ...
      poolMembers: map['poolMembers'] == null ? null : pulumi.Input.decodeList<FastUdpAppPoolMember>(map['poolMembers'], (value) => FastUdpAppPoolMember.fromMap((value as Map).cast<String, dynamic>())),
      ...
      virtualServer: map['virtualServer'] == null ? null : FastUdpAppVirtualServer.fromMap((map['virtualServer'] as Map).cast<String, dynamic>()),
      vlansAlloweds: map['vlansAlloweds'] == null ? null : (map['vlansAlloweds'] as List).cast<String>(),
      vlansRejecteds: map['vlansRejecteds'] == null ? null : (map['vlansRejecteds'] as List).cast<String>(),
    );
  }
}
