...
class IpsecPolicyArgs {
  ...
  factory IpsecPolicyArgs.fromMap(Map<String, dynamic> map) {
    return IpsecPolicyArgs(
      ...
      ipcomp: map['ipcomp'] == null ? null : map['ipcomp'] as String,
      kbLifetime: map['kbLifetime'] == null ? null : map['kbLifetime'] as int,
      lifetime: map['lifetime'] == null ? null : map['lifetime'] as int,
      mode: map['mode'] == null ? null : map['mode'] as String,
      name: map['name'] as String,
      perfectForwardSecrecy: map['perfectForwardSecrecy'] == null ? null : map['perfectForwardSecrecy'] as String,
      protocol: map['protocol'] == null ? null : map['protocol'] as String,
      tunnelLocalAddress: map['tunnelLocalAddress'] == null ? null : map['tunnelLocalAddress'] as String,
      tunnelRemoteAddress: map['tunnelRemoteAddress'] == null ? null : map['tunnelRemoteAddress'] as String,
    );
  }
}
