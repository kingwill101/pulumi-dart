...
class FastHttpsAppArgs {
  ...
  FastHttpsAppArgs({
    ...
    String? existingTlsClientProfile,
    String? existingTlsServerProfile,
    String? existingWafSecurityPolicy,
    String? fallbackPersistence,
    String? loadBalancingMode,
    FastHttpsAppMonitor? monitor,
    String? persistenceProfile,
    String? persistenceType,
    List<FastHttpsAppPoolMember>? poolMembers,
    List<String>? securityLogProfiles,
    List<String>? serviceDiscoveries,
    int? slowRampTime,
    List<String>? snatPoolAddresses,
    required String tenant,
    FastHttpsAppTlsClientProfile? tlsClientProfile,
    FastHttpsAppTlsServerProfile? tlsServerProfile,
    FastHttpsAppVirtualServer? virtualServer,
    FastHttpsAppWafSecurityPolicy? wafSecurityPolicy,
  }) :
  ...
  factory FastHttpsAppArgs.fromMap(Map<String, dynamic> map) {
    return FastHttpsAppArgs(
      ...
      existingTlsClientProfile: map['existingTlsClientProfile'] == null ? null : map['existingTlsClientProfile'] as String,
      existingTlsServerProfile: map['existingTlsServerProfile'] == null ? null : map['existingTlsServerProfile'] as String,
      ...
      monitor: map['monitor'] == null ? null : FastHttpsAppMonitor.fromMap((map['monitor'] as Map).cast<String, dynamic>()),
      ...
      poolMembers: map['poolMembers'] == null ? null : pulumi.Input.decodeList<FastHttpsAppPoolMember>(map['poolMembers'], (value) => FastHttpsAppPoolMember.fromMap((value as Map).cast<String, dynamic>())),
      ...
      tlsClientProfile: map['tlsClientProfile'] == null ? null : FastHttpsAppTlsClientProfile.fromMap((map['tlsClientProfile'] as Map).cast<String, dynamic>()),
      tlsServerProfile: map['tlsServerProfile'] == null ? null : FastHttpsAppTlsServerProfile.fromMap((map['tlsServerProfile'] as Map).cast<String, dynamic>()),
      virtualServer: map['virtualServer'] == null ? null : FastHttpsAppVirtualServer.fromMap((map['virtualServer'] as Map).cast<String, dynamic>()),
      wafSecurityPolicy: map['wafSecurityPolicy'] == null ? null : FastHttpsAppWafSecurityPolicy.fromMap((map['wafSecurityPolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
