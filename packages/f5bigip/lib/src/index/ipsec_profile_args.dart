...
class IpsecProfileArgs {
  ...
  factory IpsecProfileArgs.fromMap(Map<String, dynamic> map) {
    return IpsecProfileArgs(
      ...
      parentProfile: map['parentProfile'] == null ? null : map['parentProfile'] as String,
      trafficSelector: map['trafficSelector'] == null ? null : map['trafficSelector'] as String,
    );
  }
}
