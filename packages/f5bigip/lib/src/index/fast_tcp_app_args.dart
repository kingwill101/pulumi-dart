...
class FastTcpAppArgs {
  ...
  FastTcpAppArgs({
    ...
    FastTcpAppMonitor? monitor,
    String? persistenceProfile,
    String? persistenceType,
    List<FastTcpAppPoolMember>? poolMembers,
    int? slowRampTime,
    List<String>? snatPoolAddresses,
    required String tenant,
    FastTcpAppVirtualServer? virtualServer,
  }) :
  ...
  factory FastTcpAppArgs.fromMap(Map<String, dynamic> map) {
    return FastTcpAppArgs(
      ...
      monitor: map['monitor'] == null ? null : FastTcpAppMonitor.fromMap((map['monitor'] as Map).cast<String, dynamic>()),
      ...
      poolMembers: map['poolMembers'] == null ? null : pulumi.Input.decodeList<FastTcpAppPoolMember>(map['poolMembers'], (value) => FastTcpAppPoolMember.fromMap((value as Map).cast<String, dynamic>())),
      ...
      virtualServer: map['virtualServer'] == null ? null : FastTcpAppVirtualServer.fromMap((map['virtualServer'] as Map).cast<String, dynamic>()),
    );
  }
}
