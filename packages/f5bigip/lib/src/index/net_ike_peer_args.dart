...
class NetIkePeerArgs {
  ...
  NetIkePeerArgs({
    ...
    String? mode,
    String? myCertFile,
    String? myCertKeyFile,
    String? myCertKeyPassphrase,
    String? myIdType,
    String? myIdValue,
    required String name,
    String? natTraversal,
    String? passive,
    String? peersCertFile,
    String? peersCertType,
    String? peersIdType,
    String? peersIdValue,
    String? phase1AuthMethod,
    String? phase1EncryptAlgorithm,
    String? phase1HashAlgorithm,
    String? phase1PerfectForwardSecrecy,
    String? presharedKey,
    String? presharedKeyEncrypted,
    String? prf,
    String? proxySupport,
    required String remoteAddress,
    int? replayWindowSize,
    String? state,
    List<String>? trafficSelectors,
    String? verifyCert,
  ...
  factory NetIkePeerArgs.fromMap(Map<String, dynamic> map) {
    return NetIkePeerArgs(
      ...
      caCertFile: map['caCertFile'] == null ? null : map['caCertFile'] as String,
      crlFile: map['crlFile'] == null ? null : map['crlFile'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      dpdDelay: map['dpdDelay'] == null ? null : map['dpdDelay'] as int,
      generatePolicy: map['generatePolicy'] == null ? null : map['generatePolicy'] as String,
      lifetime: map['lifetime'] == null ? null : map['lifetime'] as int,
      mode: map['mode'] == null ? null : map['mode'] as String,
      myCertFile: map['myCertFile'] == null ? null : map['myCertFile'] as String,
      myCertKeyFile: map['myCertKeyFile'] == null ? null : map['myCertKeyFile'] as String,
      myCertKeyPassphrase: map['myCertKeyPassphrase'] == null ? null : map['myCertKeyPassphrase'] as String,
      myIdType: map['myIdType'] == null ? null : map['myIdType'] as String,
      myIdValue: map['myIdValue'] == null ? null : map['myIdValue'] as String,
      name: map['name'] as String,
      natTraversal: map['natTraversal'] == null ? null : map['natTraversal'] as String,
      passive: map['passive'] == null ? null : map['passive'] as String,
      peersCertFile: map['peersCertFile'] == null ? null : map['peersCertFile'] as String,
      peersCertType: map['peersCertType'] == null ? null : map['peersCertType'] as String,
      peersIdType: map['peersIdType'] == null ? null : map['peersIdType'] as String,
      peersIdValue: map['peersIdValue'] == null ? null : map['peersIdValue'] as String,
      phase1AuthMethod: map['phase1AuthMethod'] == null ? null : map['phase1AuthMethod'] as String,
      phase1EncryptAlgorithm: map['phase1EncryptAlgorithm'] == null ? null : map['phase1EncryptAlgorithm'] as String,
      phase1HashAlgorithm: map['phase1HashAlgorithm'] == null ? null : map['phase1HashAlgorithm'] as String,
      phase1PerfectForwardSecrecy: map['phase1PerfectForwardSecrecy'] == null ? null : map['phase1PerfectForwardSecrecy'] as String,
      presharedKey: map['presharedKey'] == null ? null : map['presharedKey'] as String,
      presharedKeyEncrypted: map['presharedKeyEncrypted'] == null ? null : map['presharedKeyEncrypted'] as String,
      prf: map['prf'] == null ? null : map['prf'] as String,
      proxySupport: map['proxySupport'] == null ? null : map['proxySupport'] as String,
      remoteAddress: map['remoteAddress'] as String,
      replayWindowSize: map['replayWindowSize'] == null ? null : map['replayWindowSize'] as int,
      state: map['state'] == null ? null : map['state'] as String,
      trafficSelectors: map['trafficSelectors'] == null ? null : (map['trafficSelectors'] as List).cast<String>(),
      verifyCert: map['verifyCert'] == null ? null : map['verifyCert'] as String,
