...
class WafPolicyArgs {
  ...
  WafPolicyArgs({
    ...
    List<WafPolicyFileType>? fileTypes,
    List<WafPolicyGraphqlProfile>? graphqlProfiles,
    List<WafPolicyHostName>? hostNames,
    List<WafPolicyIpException>? ipExceptions,
    List<String>? modifications,
    required String name,
    List<String>? openApiFiles,
    List<String>? parameters,
    String? partition,
    List<WafPolicyPolicyBuilder>? policyBuilders,
    String? policyId,
    String? policyImportJson,
    bool? protocolIndependent,
    List<String>? serverTechnologies,
    List<String>? signatureSets,
    List<String>? signatures,
    List<WafPolicySignaturesSetting>? signaturesSettings,
    String? templateLink,
  ...
  factory WafPolicyArgs.fromMap(Map<String, dynamic> map) {
    return WafPolicyArgs(
      applicationLanguage: map['applicationLanguage'] == null ? null : map['applicationLanguage'] as String,
      caseInsensitive: map['caseInsensitive'] == null ? null : map['caseInsensitive'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      enablePassivemode: map['enablePassivemode'] == null ? null : map['enablePassivemode'] as bool,
      enforcementMode: map['enforcementMode'] == null ? null : map['enforcementMode'] as String,
      fileTypes: map['fileTypes'] == null ? null : pulumi.Input.decodeList<WafPolicyFileType>(map['fileTypes'], (value) => WafPolicyFileType.fromMap((value as Map).cast<String, dynamic>())),
      graphqlProfiles: map['graphqlProfiles'] == null ? null : pulumi.Input.decodeList<WafPolicyGraphqlProfile>(map['graphqlProfiles'], (value) => WafPolicyGraphqlProfile.fromMap((value as Map).cast<String, dynamic>())),
      hostNames: map['hostNames'] == null ? null : pulumi.Input.decodeList<WafPolicyHostName>(map['hostNames'], (value) => WafPolicyHostName.fromMap((value as Map).cast<String, dynamic>())),
      ipExceptions: map['ipExceptions'] == null ? null : pulumi.Input.decodeList<WafPolicyIpException>(map['ipExceptions'], (value) => WafPolicyIpException.fromMap((value as Map).cast<String, dynamic>())),
      modifications: map['modifications'] == null ? null : (map['modifications'] as List).cast<String>(),
      name: map['name'] as String,
      openApiFiles: map['openApiFiles'] == null ? null : (map['openApiFiles'] as List).cast<String>(),
      ...
      policyBuilders: map['policyBuilders'] == null ? null : pulumi.Input.decodeList<WafPolicyPolicyBuilder>(map['policyBuilders'], (value) => WafPolicyPolicyBuilder.fromMap((value as Map).cast<String, dynamic>())),
      policyId: map['policyId'] == null ? null : map['policyId'] as String,
      policyImportJson: map['policyImportJson'] == null ? null : map['policyImportJson'] as String,
      protocolIndependent: map['protocolIndependent'] == null ? null : map['protocolIndependent'] as bool,
      serverTechnologies: map['serverTechnologies'] == null ? null : (map['serverTechnologies'] as List).cast<String>(),
      signatureSets: map['signatureSets'] == null ? null : (map['signatureSets'] as List).cast<String>(),
      signatures: map['signatures'] == null ? null : (map['signatures'] as List).cast<String>(),
      signaturesSettings: map['signaturesSettings'] == null ? null : pulumi.Input.decodeList<WafPolicySignaturesSetting>(map['signaturesSettings'], (value) => WafPolicySignaturesSetting.fromMap((value as Map).cast<String, dynamic>())),
      templateLink: map['templateLink'] == null ? null : map['templateLink'] as String,
