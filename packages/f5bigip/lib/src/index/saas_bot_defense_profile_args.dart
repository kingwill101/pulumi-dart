...
class SaasBotDefenseProfileArgs {
  ...
  SaasBotDefenseProfileArgs({
    ...
    required List<SaasBotDefenseProfileProtectedEndpoint> protectedEndpoints,
    required String shapeProtectionPool,
    required String sslProfile,
  ...
  factory SaasBotDefenseProfileArgs.fromMap(Map<String, dynamic> map) {
    return SaasBotDefenseProfileArgs(
      ...
      protectedEndpoints: pulumi.Input.decodeList<SaasBotDefenseProfileProtectedEndpoint>(map['protectedEndpoints'], (value) => SaasBotDefenseProfileProtectedEndpoint.fromMap((value as Map).cast<String, dynamic>())),
      shapeProtectionPool: map['shapeProtectionPool'] as String,
      sslProfile: map['sslProfile'] as String,
