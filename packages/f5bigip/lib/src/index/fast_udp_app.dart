...
class FastUdpApp extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<FastUdpAppPoolMember>?> poolMembers;
  ...
  FastUdpApp(
    ...
    this.poolMembers = registerOutput<List<FastUdpAppPoolMember>?>('poolMembers');
    ...
    this.virtualServer = registerOutput<FastUdpAppVirtualServer?>('virtualServer');
    this.vlansAlloweds = registerOutput<List<String>?>('vlansAlloweds');
    this.vlansRejecteds = registerOutput<List<String>?>('vlansRejecteds');
  }
}
