...
class EventServiceDiscoveryArgs {
  ...
  EventServiceDiscoveryArgs({
    List<EventServiceDiscoveryNode>? nodes,
  ...
  factory EventServiceDiscoveryArgs.fromMap(Map<String, dynamic> map) {
    return EventServiceDiscoveryArgs(
      nodes: map['nodes'] == null ? null : pulumi.Input.decodeList<EventServiceDiscoveryNode>(map['nodes'], (value) => EventServiceDiscoveryNode.fromMap((value as Map).cast<String, dynamic>())),
