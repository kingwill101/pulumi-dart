...
/// {@template pulumi_index_as3_as3_args_doc}
/// The set of arguments for As3.
/// {@endtemplate}
/// {@macro pulumi_index_as3_as3_args_doc}
class As3Args {
  ...
  factory As3Args.fromMap(Map<String, dynamic> map) {
    return As3Args(
      applicationList: map['applicationList'] == null ? null : map['applicationList'] as String,
      as3Json: map['as3Json'] == null ? null : map['as3Json'] as String,
      controls: map['controls'] == null ? null : (map['controls'] as Map).cast<String, String>(),
      deleteApps: map['deleteApps'] == null ? null : As3DeleteApps.fromMap((map['deleteApps'] as Map).cast<String, dynamic>()),
      ignoreMetadata: map['ignoreMetadata'] == null ? null : map['ignoreMetadata'] as bool,
      taskId: map['taskId'] == null ? null : map['taskId'] as String,
      tenantFilter: map['tenantFilter'] == null ? null : map['tenantFilter'] as String,
      tenantList: map['tenantList'] == null ? null : map['tenantList'] as String,
