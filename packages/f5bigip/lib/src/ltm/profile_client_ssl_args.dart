...
class ProfileClientSslArgs {
  ...
  ProfileClientSslArgs({
    String? alertTimeout,
    String? allowExpiredCrl,
    String? allowNonSsl,
    String? authenticate,
    int? authenticateDepth,
    String? c3dClientFallbackCert,
    String? c3dDropUnknownOcspStatus,
    String? c3dOcsp,
    String? caFile,
    int? cacheSize,
    int? cacheTimeout,
    String? cert,
    List<String>? certExtensionIncludes,
    ProfileClientSslCertKeyChain? certKeyChain,
    int? certLifeSpan,
    String? certLookupByIpaddrPort,
    String? chain,
    String? cipherGroup,
    String? ciphers,
    String? clientCertCa,
    String? crlFile,
    String? defaultsFrom,
    String? forwardProxyBypassDefaultAction,
    String? fullPath,
    int? generation,
    String? genericAlert,
    String? handshakeTimeout,
    String? inheritCertKeychain,
    String? key,
    String? modSslMethods,
    String? mode,
    ...
    String? proxyCaCert,
    String? proxyCaKey,
    String? proxyCaPassphrase,
    String? proxySsl,
    String? proxySslPassthrough,
    String? renegotiatePeriod,
    String? renegotiateSize,
    String? renegotiation,
    String? retainCertificate,
    String? secureRenegotiation,
    String? serverName,
    String? sessionMirroring,
    String? sessionTicket,
    String? sniDefault,
    String? sniRequire,
    String? sslC3d,
    String? sslForwardProxy,
    String? sslForwardProxyBypass,
    String? sslSignHash,
    String? strictResume,
    List<String>? tmOptions,
    String? uncleanShutdown,
  }) :
  ...
  factory ProfileClientSslArgs.fromMap(Map<String, dynamic> map) {
    return ProfileClientSslArgs(
      alertTimeout: map['alertTimeout'] == null ? null : map['alertTimeout'] as String,
      allowExpiredCrl: map['allowExpiredCrl'] == null ? null : map['allowExpiredCrl'] as String,
      allowNonSsl: map['allowNonSsl'] == null ? null : map['allowNonSsl'] as String,
      authenticate: map['authenticate'] == null ? null : map['authenticate'] as String,
      authenticateDepth: map['authenticateDepth'] == null ? null : map['authenticateDepth'] as int,
      c3dClientFallbackCert: map['c3dClientFallbackCert'] == null ? null : map['c3dClientFallbackCert'] as String,
      c3dDropUnknownOcspStatus: map['c3dDropUnknownOcspStatus'] == null ? null : map['c3dDropUnknownOcspStatus'] as String,
      c3dOcsp: map['c3dOcsp'] == null ? null : map['c3dOcsp'] as String,
      caFile: map['caFile'] == null ? null : map['caFile'] as String,
      cacheSize: map['cacheSize'] == null ? null : map['cacheSize'] as int,
      cacheTimeout: map['cacheTimeout'] == null ? null : map['cacheTimeout'] as int,
      cert: map['cert'] == null ? null : map['cert'] as String,
      certExtensionIncludes: map['certExtensionIncludes'] == null ? null : (map['certExtensionIncludes'] as List).cast<String>(),
      certKeyChain: map['certKeyChain'] == null ? null : ProfileClientSslCertKeyChain.fromMap((map['certKeyChain'] as Map).cast<String, dynamic>()),
      certLifeSpan: map['certLifeSpan'] == null ? null : map['certLifeSpan'] as int,
      certLookupByIpaddrPort: map['certLookupByIpaddrPort'] == null ? null : map['certLookupByIpaddrPort'] as String,
      chain: map['chain'] == null ? null : map['chain'] as String,
      cipherGroup: map['cipherGroup'] == null ? null : map['cipherGroup'] as String,
      ciphers: map['ciphers'] == null ? null : map['ciphers'] as String,
      clientCertCa: map['clientCertCa'] == null ? null : map['clientCertCa'] as String,
      crlFile: map['crlFile'] == null ? null : map['crlFile'] as String,
      defaultsFrom: map['defaultsFrom'] == null ? null : map['defaultsFrom'] as String,
      forwardProxyBypassDefaultAction: map['forwardProxyBypassDefaultAction'] == null ? null : map['forwardProxyBypassDefaultAction'] as String,
      fullPath: map['fullPath'] == null ? null : map['fullPath'] as String,
      generation: map['generation'] == null ? null : map['generation'] as int,
      genericAlert: map['genericAlert'] == null ? null : map['genericAlert'] as String,
      handshakeTimeout: map['handshakeTimeout'] == null ? null : map['handshakeTimeout'] as String,
      inheritCertKeychain: map['inheritCertKeychain'] == null ? null : map['inheritCertKeychain'] as String,
      key: map['key'] == null ? null : map['key'] as String,
      modSslMethods: map['modSslMethods'] == null ? null : map['modSslMethods'] as String,
      mode: map['mode'] == null ? null : map['mode'] as String,
      name: map['name'] as String,
      ocspStapling: map['ocspStapling'] == null ? null : map['ocspStapling'] as String,
      partition: map['partition'] == null ? null : map['partition'] as String,
      passphrase: map['passphrase'] == null ? null : map['passphrase'] as String,
      peerCertMode: map['peerCertMode'] == null ? null : map['peerCertMode'] as String,
      proxyCaCert: map['proxyCaCert'] == null ? null : map['proxyCaCert'] as String,
      proxyCaKey: map['proxyCaKey'] == null ? null : map['proxyCaKey'] as String,
      proxyCaPassphrase: map['proxyCaPassphrase'] == null ? null : map['proxyCaPassphrase'] as String,
      proxySsl: map['proxySsl'] == null ? null : map['proxySsl'] as String,
      proxySslPassthrough: map['proxySslPassthrough'] == null ? null : map['proxySslPassthrough'] as String,
      renegotiatePeriod: map['renegotiatePeriod'] == null ? null : map['renegotiatePeriod'] as String,
      renegotiateSize: map['renegotiateSize'] == null ? null : map['renegotiateSize'] as String,
      renegotiation: map['renegotiation'] == null ? null : map['renegotiation'] as String,
      retainCertificate: map['retainCertificate'] == null ? null : map['retainCertificate'] as String,
      secureRenegotiation: map['secureRenegotiation'] == null ? null : map['secureRenegotiation'] as String,
      serverName: map['serverName'] == null ? null : map['serverName'] as String,
      sessionMirroring: map['sessionMirroring'] == null ? null : map['sessionMirroring'] as String,
      sessionTicket: map['sessionTicket'] == null ? null : map['sessionTicket'] as String,
      sniDefault: map['sniDefault'] == null ? null : map['sniDefault'] as String,
      sniRequire: map['sniRequire'] == null ? null : map['sniRequire'] as String,
      sslC3d: map['sslC3d'] == null ? null : map['sslC3d'] as String,
      sslForwardProxy: map['sslForwardProxy'] == null ? null : map['sslForwardProxy'] as String,
      sslForwardProxyBypass: map['sslForwardProxyBypass'] == null ? null : map['sslForwardProxyBypass'] as String,
      sslSignHash: map['sslSignHash'] == null ? null : map['sslSignHash'] as String,
      strictResume: map['strictResume'] == null ? null : map['strictResume'] as String,
      tmOptions: map['tmOptions'] == null ? null : (map['tmOptions'] as List).cast<String>(),
      uncleanShutdown: map['uncleanShutdown'] == null ? null : map['uncleanShutdown'] as String,
    );
  }
}
