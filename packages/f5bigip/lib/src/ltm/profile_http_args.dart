...
class ProfileHttpArgs {
  ...
  ProfileHttpArgs({
    ...
    List<String>? encryptCookies,
    List<ProfileHttpEnforcement>? enforcements,
    String? fallbackHost,
    List<String>? fallbackStatusCodes,
    String? headErase,
    String? headInsert,
    List<ProfileHttpHttpStrictTransportSecurity>? httpStrictTransportSecurities,
    ...
    List<String>? responseHeadersPermitteds,
    String? serverAgentName,
    String? tmPartition,
    String? viaHostName,
    String? viaRequest,
    String? viaResponse,
    List<String>? xffAlternativeNames,
  }) :
  ...
  factory ProfileHttpArgs.fromMap(Map<String, dynamic> map) {
    return ProfileHttpArgs(
      acceptXff: map['acceptXff'] == null ? null : map['acceptXff'] as String,
      appService: map['appService'] == null ? null : map['appService'] as String,
      basicAuthRealm: map['basicAuthRealm'] == null ? null : map['basicAuthRealm'] as String,
      defaultsFrom: map['defaultsFrom'] == null ? null : map['defaultsFrom'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      encryptCookieSecret: map['encryptCookieSecret'] == null ? null : map['encryptCookieSecret'] as String,
      encryptCookies: map['encryptCookies'] == null ? null : (map['encryptCookies'] as List).cast<String>(),
      enforcements: map['enforcements'] == null ? null : pulumi.Input.decodeList<ProfileHttpEnforcement>(map['enforcements'], (value) => ProfileHttpEnforcement.fromMap((value as Map).cast<String, dynamic>())),
      fallbackHost: map['fallbackHost'] == null ? null : map['fallbackHost'] as String,
      fallbackStatusCodes: map['fallbackStatusCodes'] == null ? null : (map['fallbackStatusCodes'] as List).cast<String>(),
      headErase: map['headErase'] == null ? null : map['headErase'] as String,
      headInsert: map['headInsert'] == null ? null : map['headInsert'] as String,
      httpStrictTransportSecurities: map['httpStrictTransportSecurities'] == null ? null : pulumi.Input.decodeList<ProfileHttpHttpStrictTransportSecurity>(map['httpStrictTransportSecurities'], (value) => ProfileHttpHttpStrictTransportSecurity.fromMap((value as Map).cast<String, dynamic>())),
      insertXforwardedFor: map['insertXforwardedFor'] == null ? null : map['insertXforwardedFor'] as String,
      lwsSeparator: map['lwsSeparator'] == null ? null : map['lwsSeparator'] as String,
      lwsWidth: map['lwsWidth'] == null ? null : map['lwsWidth'] as int,
      name: map['name'] as String,
      oneconnectTransformations: map['oneconnectTransformations'] == null ? null : map['oneconnectTransformations'] as String,
      proxyType: map['proxyType'] == null ? null : map['proxyType'] as String,
      redirectRewrite: map['redirectRewrite'] == null ? null : map['redirectRewrite'] as String,
      requestChunking: map['requestChunking'] == null ? null : map['requestChunking'] as String,
      responseChunking: map['responseChunking'] == null ? null : map['responseChunking'] as String,
      responseHeadersPermitteds: map['responseHeadersPermitteds'] == null ? null : (map['responseHeadersPermitteds'] as List).cast<String>(),
      serverAgentName: map['serverAgentName'] == null ? null : map['serverAgentName'] as String,
      tmPartition: map['tmPartition'] == null ? null : map['tmPartition'] as String,
      viaHostName: map['viaHostName'] == null ? null : map['viaHostName'] as String,
      viaRequest: map['viaRequest'] == null ? null : map['viaRequest'] as String,
      viaResponse: map['viaResponse'] == null ? null : map['viaResponse'] as String,
      xffAlternativeNames: map['xffAlternativeNames'] == null ? null : (map['xffAlternativeNames'] as List).cast<String>(),
    );
  }
}
