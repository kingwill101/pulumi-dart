...
class ProfileRewriteUriRulesArgs {
  ...
  ProfileRewriteUriRulesArgs({
    required List<ProfileRewriteUriRulesClient> clients,
    required String profileName,
    required String ruleName,
    String? ruleType,
    required List<ProfileRewriteUriRulesServer> servers,
  }) :
  ...
  factory ProfileRewriteUriRulesArgs.fromMap(Map<String, dynamic> map) {
    return ProfileRewriteUriRulesArgs(
      clients: pulumi.Input.decodeList<ProfileRewriteUriRulesClient>(map['clients'], (value) => ProfileRewriteUriRulesClient.fromMap((value as Map).cast<String, dynamic>())),
      profileName: map['profileName'] as String,
      ruleName: map['ruleName'] as String,
      ruleType: map['ruleType'] == null ? null : map['ruleType'] as String,
      servers: pulumi.Input.decodeList<ProfileRewriteUriRulesServer>(map['servers'], (value) => ProfileRewriteUriRulesServer.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
