...
class DataGroupArgs {
  ...
  factory DataGroupArgs.fromMap(Map<String, dynamic> map) {
    return DataGroupArgs(
      ...
      records: map['records'] == null ? null : pulumi.Input.decodeList<DataGroupRecord>(map['records'], (value) => DataGroupRecord.fromMap((value as Map).cast<String, dynamic>())),
      recordsSrc: map['recordsSrc'] == null ? null : map['recordsSrc'] as String,
