...
class VirtualAddressArgs {
  ...
  factory VirtualAddressArgs.fromMap(Map<String, dynamic> map) {
    return VirtualAddressArgs(
      advertizeRoute: map['advertizeRoute'] == null ? null : map['advertizeRoute'] as String,
      arp: map['arp'] == null ? null : map['arp'] as bool,
      autoDelete: map['autoDelete'] == null ? null : map['autoDelete'] as bool,
      connLimit: map['connLimit'] == null ? null : map['connLimit'] as int,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      icmpEcho: map['icmpEcho'] == null ? null : map['icmpEcho'] as String,
