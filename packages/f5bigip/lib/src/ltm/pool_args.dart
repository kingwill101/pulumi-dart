...
class PoolArgs {
  ...
  factory PoolArgs.fromMap(Map<String, dynamic> map) {
    return PoolArgs(
      allowNat: map['allowNat'] == null ? null : map['allowNat'] as String,
      allowSnat: map['allowSnat'] == null ? null : map['allowSnat'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      loadBalancingMode: map['loadBalancingMode'] == null ? null : map['loadBalancingMode'] as String,
      minimumActiveMembers: map['minimumActiveMembers'] == null ? null : map['minimumActiveMembers'] as int,
      monitors: map['monitors'] == null ? null : (map['monitors'] as List).cast<String>(),
      name: map['name'] as String,
      reselectTries: map['reselectTries'] == null ? null : map['reselectTries'] as int,
      serviceDownAction: map['serviceDownAction'] == null ? null : map['serviceDownAction'] as String,
