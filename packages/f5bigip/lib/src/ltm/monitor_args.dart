...
class MonitorArgs {
  ...
  factory MonitorArgs.fromMap(Map<String, dynamic> map) {
    return MonitorArgs(
      adaptive: map['adaptive'] == null ? null : map['adaptive'] as String,
      adaptiveLimit: map['adaptiveLimit'] == null ? null : map['adaptiveLimit'] as int,
      base: map['base'] == null ? null : map['base'] as String,
      chaseReferrals: map['chaseReferrals'] == null ? null : map['chaseReferrals'] as String,
      compatibility: map['compatibility'] == null ? null : map['compatibility'] as String,
      customParent: map['customParent'] == null ? null : map['customParent'] as String,
      ...
      ipDscp: map['ipDscp'] == null ? null : map['ipDscp'] as int,
      mandatoryAttributes: map['mandatoryAttributes'] == null ? null : map['mandatoryAttributes'] as String,
      manualResume: map['manualResume'] == null ? null : map['manualResume'] as String,
      mode: map['mode'] == null ? null : map['mode'] as String,
      name: map['name'] as String,
      parent: map['parent'] as String,
      password: map['password'] == null ? null : map['password'] as String,
      receive: map['receive'] == null ? null : map['receive'] as String,
      receiveDisable: map['receiveDisable'] == null ? null : map['receiveDisable'] as String,
      reverse: map['reverse'] == null ? null : map['reverse'] as String,
      security: map['security'] == null ? null : map['security'] as String,
      send: map['send'] == null ? null : map['send'] as String,
      sslProfile: map['sslProfile'] == null ? null : map['sslProfile'] as String,
      timeUntilUp: map['timeUntilUp'] == null ? null : map['timeUntilUp'] as int,
      timeout: map['timeout'] == null ? null : map['timeout'] as int,
      transparent: map['transparent'] == null ? null : map['transparent'] as String,
      upInterval: map['upInterval'] == null ? null : map['upInterval'] as int,
