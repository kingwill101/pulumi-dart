...
class SnatArgs {
  ...
  SnatArgs({
    ...
    required List<SnatOrigin> origins,
    String? partition,
    String? snatpool,
    String? sourceport,
    String? translation,
  ...
  factory SnatArgs.fromMap(Map<String, dynamic> map) {
    return SnatArgs(
      ...
      origins: pulumi.Input.decodeList<SnatOrigin>(map['origins'], (value) => SnatOrigin.fromMap((value as Map).cast<String, dynamic>())),
      ...
      translation: map['translation'] == null ? null : map['translation'] as String,
      vlans: map['vlans'] == null ? null : (map['vlans'] as List).cast<String>(),
      vlansdisabled: map['vlansdisabled'] == null ? null : map['vlansdisabled'] as bool,
    );
  }
}
