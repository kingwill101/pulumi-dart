...
class ProfileFastHttpArgs {
  ...
  ProfileFastHttpArgs({
    int? connpoolMaxreuse,
    int? connpoolMaxsize,
    int? connpoolMinsize,
    String? connpoolReplenish,
    int? connpoolStep,
    int? connpoolidleTimeoutoverride,
    String? defaultsFrom,
    String? forcehttp10response,
    int? idleTimeout,
    int? maxheaderSize,
  ...
  factory ProfileFastHttpArgs.fromMap(Map<String, dynamic> map) {
    return ProfileFastHttpArgs(
      connpoolMaxreuse: map['connpoolMaxreuse'] == null ? null : map['connpoolMaxreuse'] as int,
      connpoolMaxsize: map['connpoolMaxsize'] == null ? null : map['connpoolMaxsize'] as int,
      connpoolMinsize: map['connpoolMinsize'] == null ? null : map['connpoolMinsize'] as int,
      connpoolReplenish: map['connpoolReplenish'] == null ? null : map['connpoolReplenish'] as String,
      connpoolStep: map['connpoolStep'] == null ? null : map['connpoolStep'] as int,
      connpoolidleTimeoutoverride: map['connpoolidleTimeoutoverride'] == null ? null : map['connpoolidleTimeoutoverride'] as int,
      defaultsFrom: map['defaultsFrom'] == null ? null : map['defaultsFrom'] as String,
      forcehttp10response: map['forcehttp10response'] == null ? null : map['forcehttp10response'] as String,
