...
class ProfileHttpCompress extends pulumi.CustomResource {
  ...
  ProfileHttpCompress(
    ...
    this.compressionBuffersize = registerOutput<int>('compressionBuffersize');
    this.contentTypeExcludes = registerOutput<List<String>>('contentTypeExcludes');
    this.contentTypeIncludes = registerOutput<List<String>>('contentTypeIncludes');
    this.cpuSaver = registerOutput<String>('cpuSaver');
    this.defaultsFrom = registerOutput<String>('defaultsFrom');
    this.gzipCompressionLevel = registerOutput<int>('gzipCompressionLevel');
    this.gzipMemoryLevel = registerOutput<int>('gzipMemoryLevel');
    this.gzipWindowSize = registerOutput<int>('gzipWindowSize');
    this.keepAcceptEncoding = registerOutput<String>('keepAcceptEncoding');
    this.name = registerOutput<String>('name');
    this.uriExcludes = registerOutput<List<String>>('uriExcludes');
    this.uriIncludes = registerOutput<List<String>>('uriIncludes');
    this.varyHeader = registerOutput<String>('varyHeader');
  }
}
