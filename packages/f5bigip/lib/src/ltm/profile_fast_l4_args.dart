...
class ProfileFastL4Args {
  ...
  ProfileFastL4Args({
    int? clientTimeout,
    String? defaultsFrom,
    String? explicitflowMigration,
    String? hardwareSyncookie,
    String? idleTimeout,
    String? iptosToclient,
    String? iptosToserver,
    String? keepaliveInterval,
    String? lateBinding,
    String? looseClose,
    String? looseInitiation,
    required String name,
    String? partition,
    int? receiveWindowsize,
    String? tcpHandshakeTimeout,
  }) :
  ...
  factory ProfileFastL4Args.fromMap(Map<String, dynamic> map) {
    return ProfileFastL4Args(
      clientTimeout: map['clientTimeout'] == null ? null : map['clientTimeout'] as int,
      defaultsFrom: map['defaultsFrom'] == null ? null : map['defaultsFrom'] as String,
      explicitflowMigration: map['explicitflowMigration'] == null ? null : map['explicitflowMigration'] as String,
      hardwareSyncookie: map['hardwareSyncookie'] == null ? null : map['hardwareSyncookie'] as String,
      idleTimeout: map['idleTimeout'] == null ? null : map['idleTimeout'] as String,
      iptosToclient: map['iptosToclient'] == null ? null : map['iptosToclient'] as String,
      iptosToserver: map['iptosToserver'] == null ? null : map['iptosToserver'] as String,
      keepaliveInterval: map['keepaliveInterval'] == null ? null : map['keepaliveInterval'] as String,
      lateBinding: map['lateBinding'] == null ? null : map['lateBinding'] as String,
      looseClose: map['looseClose'] == null ? null : map['looseClose'] as String,
      looseInitiation: map['looseInitiation'] == null ? null : map['looseInitiation'] as String,
      ...
      tcpHandshakeTimeout: map['tcpHandshakeTimeout'] == null ? null : map['tcpHandshakeTimeout'] as String,
    );
  }
}
