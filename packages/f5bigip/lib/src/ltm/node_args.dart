...
class NodeArgs {
  ...
  factory NodeArgs.fromMap(Map<String, dynamic> map) {
    return NodeArgs(
      ...
      fqdn: map['fqdn'] == null ? null : NodeFqdn.fromMap((map['fqdn'] as Map).cast<String, dynamic>()),
      monitor: map['monitor'] == null ? null : map['monitor'] as String,
      name: map['name'] as String,
      rateLimit: map['rateLimit'] == null ? null : map['rateLimit'] as String,
      ratio: map['ratio'] == null ? null : map['ratio'] as int,
      session: map['session'] == null ? null : map['session'] as String,
