...
class ProfileOneConnectArgs {
  ...
  factory ProfileOneConnectArgs.fromMap(Map<String, dynamic> map) {
    return ProfileOneConnectArgs(
      ...
      idleTimeoutOverride: map['idleTimeoutOverride'] == null ? null : map['idleTimeoutOverride'] as String,
      limitType: map['limitType'] == null ? null : map['limitType'] as String,
      maxAge: map['maxAge'] == null ? null : map['maxAge'] as int,
      maxReuse: map['maxReuse'] == null ? null : map['maxReuse'] as int,
      maxSize: map['maxSize'] == null ? null : map['maxSize'] as int,
      name: map['name'] as String,
      partition: map['partition'] == null ? null : map['partition'] as String,
      sharePools: map['sharePools'] == null ? null : map['sharePools'] as String,
      sourceMask: map['sourceMask'] == null ? null : map['sourceMask'] as String,
    );
  }
}
