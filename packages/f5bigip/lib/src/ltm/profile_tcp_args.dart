...
/// {@template pulumi_ltm_profile_tcp_profile_tcp_args_doc}
/// The set of arguments for ProfileTcp.
/// {@endtemplate}
/// {@macro pulumi_ltm_profile_tcp_profile_tcp_args_doc}
class ProfileTcpArgs {
  ...
  ProfileTcpArgs({
    ...
    String? defaultsFrom,
    String? deferredAccept,
    String? delayedAcks,
    String? earlyRetransmit,
    String? fastOpen,
    int? finwait2timeout,
    int? finwaitTimeout,
    int? idleTimeout,
    int? initialCongestionWindowsize,
    ...
    String? timewaitRecycle,
    String? verifiedAccept,
    int? zerowindowTimeout,
  }) :
  ...
  factory ProfileTcpArgs.fromMap(Map<String, dynamic> map) {
    return ProfileTcpArgs(
      closeWaitTimeout: map['closeWaitTimeout'] == null ? null : map['closeWaitTimeout'] as int,
      congestionControl: map['congestionControl'] == null ? null : map['congestionControl'] as String,
      defaultsFrom: map['defaultsFrom'] == null ? null : map['defaultsFrom'] as String,
      deferredAccept: map['deferredAccept'] == null ? null : map['deferredAccept'] as String,
      delayedAcks: map['delayedAcks'] == null ? null : map['delayedAcks'] as String,
      earlyRetransmit: map['earlyRetransmit'] == null ? null : map['earlyRetransmit'] as String,
      fastOpen: map['fastOpen'] == null ? null : map['fastOpen'] as String,
      finwait2timeout: map['finwait2timeout'] == null ? null : map['finwait2timeout'] as int,
      finwaitTimeout: map['finwaitTimeout'] == null ? null : map['finwaitTimeout'] as int,
      idleTimeout: map['idleTimeout'] == null ? null : map['idleTimeout'] as int,
      initialCongestionWindowsize: map['initialCongestionWindowsize'] == null ? null : map['initialCongestionWindowsize'] as int,
      keepaliveInterval: map['keepaliveInterval'] == null ? null : map['keepaliveInterval'] as int,
      nagle: map['nagle'] == null ? null : map['nagle'] as String,
      name: map['name'] as String,
      partition: map['partition'] == null ? null : map['partition'] as String,
      proxybufferHigh: map['proxybufferHigh'] == null ? null : map['proxybufferHigh'] as int,
      receiveWindowsize: map['receiveWindowsize'] == null ? null : map['receiveWindowsize'] as int,
      sendBuffersize: map['sendBuffersize'] == null ? null : map['sendBuffersize'] as int,
      taillossProbe: map['taillossProbe'] == null ? null : map['taillossProbe'] as String,
      timewaitRecycle: map['timewaitRecycle'] == null ? null : map['timewaitRecycle'] as String,
      verifiedAccept: map['verifiedAccept'] == null ? null : map['verifiedAccept'] as String,
      zerowindowTimeout: map['zerowindowTimeout'] == null ? null : map['zerowindowTimeout'] as int,
    );
  }
}
