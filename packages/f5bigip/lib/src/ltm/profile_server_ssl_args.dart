...
/// {@template pulumi_ltm_profile_server_ssl_profile_server_ssl_args_doc}
/// The set of arguments for ProfileServerSsl.
/// {@endtemplate}
/// {@macro pulumi_ltm_profile_server_ssl_profile_server_ssl_args_doc}
class ProfileServerSslArgs {
  ...
  /// Creates a new [ProfileServerSslArgs].
  ...
  ProfileServerSslArgs({
    ...
    String? c3dCaCert,
    String? c3dCaKey,
    String? c3dCaPassphrase,
    List<String>? c3dCertExtensionCustomOids,
    List<String>? c3dCertExtensionIncludes,
    int? c3dCertLifespan,
    String? c3dCertificateExtensions,
    String? caFile,
    int? cacheSize,
    int? cacheTimeout,
    String? cert,
    ...
    String? ciphers,
    String? defaultsFrom,
    String? expireCertResponseControl,
    String? fullPath,
    int? generation,
    String? genericAlert,
    ...
    String? untrustedCertResponseControl,
  }) :
  ...
  factory ProfileServerSslArgs.fromMap(Map<String, dynamic> map) {
    return ProfileServerSslArgs(
      ...
      c3dCaCert: map['c3dCaCert'] == null ? null : map['c3dCaCert'] as String,
      c3dCaKey: map['c3dCaKey'] == null ? null : map['c3dCaKey'] as String,
      c3dCaPassphrase: map['c3dCaPassphrase'] == null ? null : map['c3dCaPassphrase'] as String,
      c3dCertExtensionCustomOids: map['c3dCertExtensionCustomOids'] == null ? null : (map['c3dCertExtensionCustomOids'] as List).cast<String>(),
      c3dCertExtensionIncludes: map['c3dCertExtensionIncludes'] == null ? null : (map['c3dCertExtensionIncludes'] as List).cast<String>(),
      c3dCertLifespan: map['c3dCertLifespan'] == null ? null : map['c3dCertLifespan'] as int,
      c3dCertificateExtensions: map['c3dCertificateExtensions'] == null ? null : map['c3dCertificateExtensions'] as String,
      ...
      expireCertResponseControl: map['expireCertResponseControl'] == null ? null : map['expireCertResponseControl'] as String,
      ...
      untrustedCertResponseControl: map['untrustedCertResponseControl'] == null ? null : map['untrustedCertResponseControl'] as String,
    );
  }
}
