...
class ProfileTcp extends pulumi.CustomResource {
  ...
  ProfileTcp(
    ...
    this.closeWaitTimeout = registerOutput<int>('closeWaitTimeout');
    this.congestionControl = registerOutput<String?>('congestionControl');
    this.defaultsFrom = registerOutput<String>('defaultsFrom');
    this.deferredAccept = registerOutput<String>('deferredAccept');
    this.delayedAcks = registerOutput<String?>('delayedAcks');
    this.earlyRetransmit = registerOutput<String?>('earlyRetransmit');
    this.fastOpen = registerOutput<String>('fastOpen');
    this.finwait2timeout = registerOutput<int>('finwait2timeout');
    this.finwaitTimeout = registerOutput<int>('finwaitTimeout');
    this.idleTimeout = registerOutput<int>('idleTimeout');
    this.initialCongestionWindowsize = registerOutput<int?>('initialCongestionWindowsize');
    this.keepaliveInterval = registerOutput<int>('keepaliveInterval');
    this.nagle = registerOutput<String?>('nagle');
    this.name = registerOutput<String>('name');
    this.partition = registerOutput<String?>('partition');
    this.proxybufferHigh = registerOutput<int?>('proxybufferHigh');
    this.receiveWindowsize = registerOutput<int?>('receiveWindowsize');
    this.sendBuffersize = registerOutput<int?>('sendBuffersize');
    this.taillossProbe = registerOutput<String?>('taillossProbe');
    this.timewaitRecycle = registerOutput<String?>('timewaitRecycle');
    this.verifiedAccept = registerOutput<String?>('verifiedAccept');
    this.zerowindowTimeout = registerOutput<int?>('zerowindowTimeout');
  }
}
