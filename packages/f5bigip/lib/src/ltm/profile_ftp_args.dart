...
class ProfileFtpArgs {
  ...
  ProfileFtpArgs({
    String? allowActiveMode,
    String? allowFtps,
    String? appService,
    String? defaultsFrom,
    String? description,
    String? enforceTlssessionReuse,
    String? ftpsMode,
    String? inheritParentProfile,
    String? inheritVlanList,
    String? logProfile,
    String? logPublisher,
  ...
  factory ProfileFtpArgs.fromMap(Map<String, dynamic> map) {
    return ProfileFtpArgs(
      allowActiveMode: map['allowActiveMode'] == null ? null : map['allowActiveMode'] as String,
      allowFtps: map['allowFtps'] == null ? null : map['allowFtps'] as String,
      ...
      enforceTlssessionReuse: map['enforceTlssessionReuse'] == null ? null : map['enforceTlssessionReuse'] as String,
      ftpsMode: map['ftpsMode'] == null ? null : map['ftpsMode'] as String,
      inheritParentProfile: map['inheritParentProfile'] == null ? null : map['inheritParentProfile'] as String,
      inheritVlanList: map['inheritVlanList'] == null ? null : map['inheritVlanList'] as String,
      logProfile: map['logProfile'] == null ? null : map['logProfile'] as String,
      logPublisher: map['logPublisher'] == null ? null : map['logPublisher'] as String,
      ...
      translateExtended: map['translateExtended'] == null ? null : map['translateExtended'] as String,
    );
  }
}
