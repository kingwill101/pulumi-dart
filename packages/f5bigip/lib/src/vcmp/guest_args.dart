...
class GuestArgs {
  ...
  GuestArgs({
    ...
    int? coresPerSlot,
    bool? deleteVirtualDisk,
    String? initialHotfix,
    String? initialImage,
    String? mgmtAddress,
    String? mgmtNetwork,
    String? mgmtRoute,
    int? minNumberOfSlots,
  ...
  factory GuestArgs.fromMap(Map<String, dynamic> map) {
    return GuestArgs(
      allowedSlots: map['allowedSlots'] == null ? null : (map['allowedSlots'] as List).cast<int>(),
      coresPerSlot: map['coresPerSlot'] == null ? null : map['coresPerSlot'] as int,
      deleteVirtualDisk: map['deleteVirtualDisk'] == null ? null : map['deleteVirtualDisk'] as bool,
      initialHotfix: map['initialHotfix'] == null ? null : map['initialHotfix'] as String,
      initialImage: map['initialImage'] == null ? null : map['initialImage'] as String,
      mgmtAddress: map['mgmtAddress'] == null ? null : map['mgmtAddress'] as String,
      mgmtNetwork: map['mgmtNetwork'] == null ? null : map['mgmtNetwork'] as String,
      mgmtRoute: map['mgmtRoute'] == null ? null : map['mgmtRoute'] as String,
      minNumberOfSlots: map['minNumberOfSlots'] == null ? null : map['minNumberOfSlots'] as int,
      name: map['name'] as String,
      numberOfSlots: map['numberOfSlots'] == null ? null : map['numberOfSlots'] as int,
