...
class Role extends pulumi.CustomResource {
  ...
  Role(
    ...
    this.assumeRole = registerOutput<String?>('assumeRole');
    this.bypassRowLevelSecurity = registerOutput<bool?>('bypassRowLevelSecurity');
    this.connectionLimit = registerOutput<int?>('connectionLimit');
    this.createDatabase = registerOutput<bool?>('createDatabase');
    this.createRole = registerOutput<bool?>('createRole');
    this.encrypted = registerOutput<String?>('encrypted');
    this.encryptedPassword = registerOutput<bool?>('encryptedPassword');
    this.idleInTransactionSessionTimeout = registerOutput<int?>('idleInTransactionSessionTimeout');
    this.inherit = registerOutput<bool?>('inherit');
    this.login = registerOutput<bool?>('login');
    ...
    this.replication = registerOutput<bool?>('replication');
    this.roles = registerOutput<List<String>?>('roles');
    this.searchPaths = registerOutput<List<String>?>('searchPaths');
    this.skipDropRole = registerOutput<bool?>('skipDropRole');
    this.skipReassignOwned = registerOutput<bool?>('skipReassignOwned');
    this.statementTimeout = registerOutput<int?>('statementTimeout');
    this.superuser = registerOutput<bool?>('superuser');
