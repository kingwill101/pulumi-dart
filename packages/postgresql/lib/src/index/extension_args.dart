...
/// {@template pulumi_index_extension_extension_args_doc}
/// The set of arguments for Extension.
/// {@endtemplate}
/// {@macro pulumi_index_extension_extension_args_doc}
class ExtensionArgs {
  ...
  factory ExtensionArgs.fromMap(Map<String, dynamic> map) {
    return ExtensionArgs(
      createCascade: map['createCascade'] == null ? null : map['createCascade'] as bool,
