...
class SchemaArgs {
  ...
  factory SchemaArgs.fromMap(Map<String, dynamic> map) {
    return SchemaArgs(
      ...
      ifNotExists: map['ifNotExists'] == null ? null : map['ifNotExists'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      owner: map['owner'] == null ? null : map['owner'] as String,
      policies: map['policies'] == null ? null : pulumi.Input.decodeList<SchemaPolicy>(map['policies'], (value) => SchemaPolicy.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
