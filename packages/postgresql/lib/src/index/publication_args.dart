...
class PublicationArgs {
  ...
  PublicationArgs({
    ...
    String? name,
    String? owner,
    List<String>? publishParams,
    bool? publishViaPartitionRootParam,
    List<String>? tables,
  }) :
  ...
  factory PublicationArgs.fromMap(Map<String, dynamic> map) {
    return PublicationArgs(
      allTables: map['allTables'] == null ? null : map['allTables'] as bool,
      ...
      publishParams: map['publishParams'] == null ? null : (map['publishParams'] as List).cast<String>(),
      publishViaPartitionRootParam: map['publishViaPartitionRootParam'] == null ? null : map['publishViaPartitionRootParam'] as bool,
