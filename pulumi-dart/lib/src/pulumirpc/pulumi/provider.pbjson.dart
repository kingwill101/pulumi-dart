...
final $typed_data.Uint8List configureRequestDescriptor = $convert.base64Decode(
    ...
    'RzX3RvX2RlbGV0ZRgGIAEoCFIWc2VuZHNPbGRJbnB1dHNUb0RlbGV0ZRo8Cg5WYXJpYWJsZXNF'
...
final $typed_data.Uint8List invokeRequestDescriptor = $convert.base64Decode(
    ...
    'UucHJvdG9idWYuU3RydWN0UgRhcmdzSgQIAxAHUghwcm92aWRlclIHdmVyc2lvblIPYWNjZXB0'
    'UmVzb3VyY2VzUhFwbHVnaW5Eb3dubG9hZFVSTA==');
...
final $typed_data.Uint8List callRequestDescriptor = $convert.base64Decode(
    ...
    'bhIyChVhY2NlcHRzX291dHB1dF92YWx1ZXMYESABKAhSE2FjY2VwdHNPdXRwdXRWYWx1ZXMaKg'
    'oUQXJndW1lbnREZXBlbmRlbmNpZXMSEgoEdXJucxgBIAMoCVIEdXJucxpvChRBcmdEZXBlbmRl'
    'bmNpZXNFbnRyeRIQCgNrZXkYASABKAlSA2tleRJBCgV2YWx1ZRgCIAEoCzIrLnB1bHVtaXJwYy'
    '5DYWxsUmVxdWVzdC5Bcmd1bWVudERlcGVuZGVuY2llc1IFdmFsdWU6AjgBGjkKC0NvbmZpZ0Vu'
    'dHJ5EhAKA2tleRgBIAEoCVIDa2V5EhQKBXZhbHVlGAIgASgJUgV2YWx1ZToCOAFKBAgEEAVKBA'
    'gFEAZKBAgNEA5KBAgQEBFKBAgPEBBSCHByb3ZpZGVyUgd2ZXJzaW9uUhFwbHVnaW5Eb3dubG9h'
    'ZFVSTFIPcGx1Z2luQ2hlY2tzdW1zUg5zb3VyY2VQb3NpdGlvbg==');
...
final $typed_data.Uint8List callResponseDescriptor = $convert.base64Decode(
    ...
    'IGcmV0dXJuEl8KEnJldHVybkRlcGVuZGVuY2llcxgCIAMoCzIvLnB1bHVtaXJwYy5DYWxsUmVz'
    'cG9uc2UuUmV0dXJuRGVwZW5kZW5jaWVzRW50cnlSEnJldHVybkRlcGVuZGVuY2llcxIzCghmYW'
    'lsdXJlcxgDIAMoCzIXLnB1bHVtaXJwYy5DaGVja0ZhaWx1cmVSCGZhaWx1cmVzGigKElJldHVy'
...
final $typed_data.Uint8List checkRequestDescriptor = $convert.base64Decode(
    ...
    'dHJ1Y3RSBG5ld3MSHgoKcmFuZG9tU2VlZBgFIAEoDFIKcmFuZG9tU2VlZEoECAQQBVIOc2VxdW'
    'VuY2VOdW1iZXI=');
...
final $typed_data.Uint8List createRequestDescriptor = $convert.base64Decode(
    ...
    'bWVvdXQSGAoHcHJldmlldxgEIAEoCFIHcHJldmlldw==');
...
final $typed_data.Uint8List createResponseDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZS5wcm90b2J1Zi5TdHJ1Y3RSCnByb3BlcnRpZXM=');
...
final $typed_data.Uint8List readRequestDescriptor = $convert.base64Decode(
    ...
    'dXRzGAQgASgLMhcuZ29vZ2xlLnByb3RvYnVmLlN0cnVjdFIGaW5wdXRz');
...
final $typed_data.Uint8List readResponseDescriptor = $convert.base64Decode(
    ...
    'ZS5wcm90b2J1Zi5TdHJ1Y3RSBmlucHV0cw==');
...
const ConstructRequest$json = {
  ...
  '2': [
    ...
    {'1': 'protect', '3': 12, '4': 1, '5': 8, '10': 'protect'},
    ...
    {'1': 'retainOnDelete', '3': 24, '4': 1, '5': 8, '10': 'retainOnDelete'},
    {
      '1': 'accepts_output_values',
      '3': 25,
      '4': 1,
...
final $typed_data.Uint8List constructRequestDescriptor = $convert.base64Decode(
    ...
    'gJUgxvcmdhbml6YXRpb24SGAoHcHJvdGVjdBgMIAEoCFIHcHJvdGVjdBIYCgdhbGlhc2VzGA4g'
    'AygJUgdhbGlhc2VzEjgKF2FkZGl0aW9uYWxTZWNyZXRPdXRwdXRzGBIgAygJUhdhZGRpdGlvbm'
    'FsU2VjcmV0T3V0cHV0cxJSCg5jdXN0b21UaW1lb3V0cxgTIAEoCzIqLnB1bHVtaXJwYy5Db25z'
    'dHJ1Y3RSZXF1ZXN0LkN1c3RvbVRpbWVvdXRzUg5jdXN0b21UaW1lb3V0cxIgCgtkZWxldGVkV2'
    'l0aBgUIAEoCVILZGVsZXRlZFdpdGgSMAoTZGVsZXRlQmVmb3JlUmVwbGFjZRgVIAEoCFITZGVs'
    'ZXRlQmVmb3JlUmVwbGFjZRIkCg1pZ25vcmVDaGFuZ2VzGBYgAygJUg1pZ25vcmVDaGFuZ2VzEi'
    'oKEHJlcGxhY2VPbkNoYW5nZXMYFyADKAlSEHJlcGxhY2VPbkNoYW5nZXMSJgoOcmV0YWluT25E'
    'ZWxldGUYGCABKAhSDnJldGFpbk9uRGVsZXRlEjIKFWFjY2VwdHNfb3V0cHV0X3ZhbHVlcxgZIA'
    'EoCFITYWNjZXB0c091dHB1dFZhbHVlcxoqChRQcm9wZXJ0eURlcGVuZGVuY2llcxISCgR1cm5z'
    'GAEgAygJUgR1cm5zGlgKDkN1c3RvbVRpbWVvdXRzEhYKBmNyZWF0ZRgBIAEoCVIGY3JlYXRlEh'
    'YKBnVwZGF0ZRgCIAEoCVIGdXBkYXRlEhYKBmRlbGV0ZRgDIAEoCVIGZGVsZXRlGjkKC0NvbmZp'
    'Z0VudHJ5EhAKA2tleRgBIAEoCVIDa2V5EhQKBXZhbHVlGAIgASgJUgV2YWx1ZToCOAEadgoWSW'
    '5wdXREZXBlbmRlbmNpZXNFbnRyeRIQCgNrZXkYASABKAlSA2tleRJGCgV2YWx1ZRgCIAEoCzIw'
    'LnB1bHVtaXJwYy5Db25zdHJ1Y3RSZXF1ZXN0LlByb3BlcnR5RGVwZW5kZW5jaWVzUgV2YWx1ZT'
    'oCOAEaPAoOUHJvdmlkZXJzRW50cnkSEAoDa2V5GAEgASgJUgNrZXkSFAoFdmFsdWUYAiABKAlS'
    'BXZhbHVlOgI4AQ==');
