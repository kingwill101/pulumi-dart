...
1. Deploy everything with the `pulumi up` command. 
    ...
    Previewing update (dev):
        ...
        Type                 Name                                 Plan
    +   pulumi:pulumi:Stack  aws-dart-stackreference-company-dev  create
    ...
    Updating (dev):
        ...
        Type                 Name                                 Status
    +   pulumi:pulumi:Stack  aws-dart-stackreference-company-dev  created
    ...
    Permalink: https://app.pulumi.com/clstokes/aws-dart-stackreference-company/dev/updates/1
    ```
...
1. Deploy everything with the `pulumi up` command. 
    ...
    Previewing update (dev):
        ...
        Type                 Name                                    Plan
    +   pulumi:pulumi:Stack  aws-dart-stackreference-department-dev  create
    ...
    Updating (dev):
        ...
        Type                 Name                                    Status
    +   pulumi:pulumi:Stack  aws-dart-stackreference-department-dev  created
    ...
    Permalink: https://app.pulumi.com/clstokes/aws-dart-stackreference-department/dev/updates/1
    ```
...
1. Set the required configuration variables, replacing `YOUR_ORG` with the name of your Pulumi organization:
    ...
    ```bash
    $ pulumi config set companyStack YOUR_ORG/aws-dart-stackreference-company/dev
    $ pulumi config set departmentStack YOUR_ORG/aws-dart-stackreference-department/dev
...
1. Deploy everything with the `pulumi up` command. 
    ...
    Previewing update (dev):
        ...
        Type                             Name                                             Plan
    +   pulumi:pulumi:Stack              aws-dart-stackreference-team-dev                 create
    >-  ├─ pulumi:pulumi:StackReference  clstokes/aws-dart-stackreference-department/dev  read
    >-  ├─ pulumi:pulumi:StackReference  clstokes/aws-dart-stackreference-company/dev     read
    ...
    Updating (dev):
        ...
        Type                             Name                                             Status
    +   pulumi:pulumi:Stack              aws-dart-stackreference-team-dev                 created
    >-  ├─ pulumi:pulumi:StackReference  clstokes/aws-dart-stackreference-company/dev     read
    >-  ├─ pulumi:pulumi:StackReference  clstokes/aws-dart-stackreference-department/dev  read
    ...
    Permalink: https://app.pulumi.com/clstokes/aws-dart-stackreference-team/dev/updates/1
    ```
