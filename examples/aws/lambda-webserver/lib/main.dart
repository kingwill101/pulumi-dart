...
class LambdaWebserverStack extends pulumi.Stack {
  late final pulumi.Output<String> websiteUrl;

  LambdaWebserverStack() {
    ...
    websiteUrl = prodStage.invokeUrl.apply<String>((url) => '$url/');
  }

  @override
  List<pulumi.OutputProperty> getOutputProperties() {
    return [pulumi.OutputProperty('websiteUrl', websiteUrl)];
  }
}
