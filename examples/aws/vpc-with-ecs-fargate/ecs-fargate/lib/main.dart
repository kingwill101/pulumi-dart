...
class ExampleStack extends pulumi.Stack {
  ...
  ExampleStack() {
    ...
    final baseTags = pulumi.Output.all<dynamic>([vpcName, vpcCidr])
    ...
    final albSecurityGroups = pulumi.Output.all<String>([
      sgroup.id,
    ...
    final serviceSecurityGroups = pulumi.Output.all<String>([
      sgroup.id,
    ]).apply<List<String>>((ids) => ids).input();
