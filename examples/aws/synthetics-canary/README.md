...
1.  Run `pulumi up` to preview and deploy changes:
    ...
    View Live: https://app.pulumi.com/acmecorp/aws-synthetics-canary/dev/updates/1
        ...
        Type                      Name                       Status
    +   pulumi:pulumi:Stack       aws-dart-synthetics-canary-dev  created
    ...
    +   ├─ aws:s3:BucketVersioning canary-scripts-versioning created
    +   ├─ aws:s3:BucketObjectv2  canary-simple-canary       created
    +   └─ aws:synthetics:Canary  canary-simple              created

    Outputs:
        simpleCanaryName: "canary-simple-a4a3974"
        simpleCanaryArn : "arn:aws:synthetics:us-east-1:052848974346:canary:canary-simple-a4a3974"
    ```
