...
class ApiGatewayAuth0Stack extends pulumi.Stack {
  late final pulumi.Output<String> url;

  ApiGatewayAuth0Stack() {
    ...
    final auth0Jwt = aws.apigatewayv2.Authorizer(
      ...
      args: aws.apigatewayv2.AuthorizerArgs(
        ...
        jwtConfiguration: aws.apigatewayv2
    ...
    url = api.apiEndpoint.apply<String>((endpoint) => '$endpoint/hello');
  }
